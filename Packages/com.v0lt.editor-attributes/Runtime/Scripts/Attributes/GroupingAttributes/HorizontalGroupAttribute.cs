...
namespace EditorAttributes
{
    ...
    public class HorizontalGroupAttribute : PropertyAttribute
    {
        ...
        public HorizontalGroupAttribute(params string[] fieldsToGroup) => FieldsToGroup = fieldsToGroup;
        ...
        public HorizontalGroupAttribute(
            ...
            float propertySpace = 0f,
            bool drawInBox = false,
            params string[] fieldsToGroup
        )
            : this(drawInBox, fieldsToGroup)
        {
