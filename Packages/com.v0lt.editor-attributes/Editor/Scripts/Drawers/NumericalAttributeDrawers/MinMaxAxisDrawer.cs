...
namespace EditorAttributes.Editor
{
    public abstract class MinMaxAxisDrawer : PropertyDrawerBase
    {
                ...
                (callback) =>
                {
                    switch (property.propertyType)
                    {
                        ...
                        case SerializedPropertyType.Vector2:
                            property.vector2Value = MinMaxVector(
                                minMaxX,
                                minMaxY,
                                minMaxZ,
                                minMaxW,
                        ...
                        case SerializedPropertyType.Vector2Int:
                            property.vector2IntValue = VectorUtils.Vector3IntToVector2Int(
                                MinMaxIntVector(
                                    minMaxX,
                                    minMaxY,
                                    minMaxZ,
                                    new(property.vector2IntValue.x, property.vector2IntValue.y)
                                )
                            );
                        ...
                        case SerializedPropertyType.Vector3:
                            property.vector3Value = MinMaxVector(
                                minMaxX,
                                minMaxY,
                                minMaxZ,
                                minMaxW,
                        ...
                        case SerializedPropertyType.Vector3Int:
                            property.vector3IntValue = MinMaxIntVector(
                                minMaxX,
                                minMaxY,
                                minMaxZ,
                        ...
                        case SerializedPropertyType.RectInt:
                            property.rectIntValue = MinMaxIntRect(
                                minMaxX,
                                minMaxY,
                                minMaxZ,
                                minMaxW,
                        ...
                        default:
                            propertyField.Add(
                                new HelpBox("The attached field must be numerical", HelpBoxMessageType.Warning)
                            );
                            return;
                    }
        ...
        protected abstract void MinMaxAxis(
            (float, float) minMaxX,
            (float, float) minMaxY,
            (float, float) minMaxZ,
            (float, float) minMaxW,
        ...
        private Vector3Int MinMaxIntVector(
            (float, float) minMaxX,
            (float, float) minMaxY,
            (float, float) minMaxZ,
