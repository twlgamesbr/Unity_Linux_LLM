...
namespace Unity.Rendering
{
    ...
    public struct HDRPMaterialPropertyDetailSmoothnessScale : IComponentData
    {
        public float Value;
    }
    ...
    {
        [RegisterBinding(
            typeof(HDRPMaterialPropertyDetailSmoothnessScale),
            nameof(HDRPMaterialPropertyDetailSmoothnessScale.Value)
        )]
        public float Value;
        ...
        class HDRPMaterialPropertyDetailSmoothnessScaleBaker : Baker<HDRPMaterialPropertyDetailSmoothnessScaleAuthoring>
        {
            ...
            {
                HDRPMaterialPropertyDetailSmoothnessScale component =
                    default(HDRPMaterialPropertyDetailSmoothnessScale);
