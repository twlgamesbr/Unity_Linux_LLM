...
namespace Unity.Rendering
{
    ...
    public class URPMaterialPropertySmoothnessAuthoring : UnityEngine.MonoBehaviour
    {
        [Unity.Entities.RegisterBinding(
            typeof(URPMaterialPropertySmoothness),
            nameof(URPMaterialPropertySmoothness.Value)
        )]
        ...
        class URPMaterialPropertySmoothnessBaker : Unity.Entities.Baker<URPMaterialPropertySmoothnessAuthoring>
        {
            ...
            {
                Unity.Rendering.URPMaterialPropertySmoothness component =
                    default(Unity.Rendering.URPMaterialPropertySmoothness);
