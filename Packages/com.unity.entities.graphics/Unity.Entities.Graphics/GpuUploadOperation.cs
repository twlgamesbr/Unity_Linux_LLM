...
namespace Unity.Rendering
{
    ...
    internal unsafe struct GpuUploadOperation
    {
        ...
        public int BytesRequiredInUploadBuffer =>
            (Kind == UploadOperationKind.Memcpy) ? Size : (Size * UnsafeUtility.SizeOf<float3x4>());
    }
    ...
    {
        [ReadOnly]
        public NativeList<ValueBlitDescriptor> BlitList;
        public ThreadedSparseUploader ThreadedSparseUploader;
