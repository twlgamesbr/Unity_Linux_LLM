# Performing submodule stripping with scripting

The `WebBuildProcessor` class allows performing submodule stripping with scripting.

Create a script in `Assets\Editor`:
<!-- The source code of the sample is  Samples~\SubmoduleStripping\Editor\SubmoduleStrippingScriptingSample.cs -->
```C#
