...
{
    /// <summary>
    /// Based on: https://github.com/keijiro/Pugrad
    /// </summary>
    static class MatplotlibColorMaps
    {
        public static Color GetViridis(float percentage)
        {
            MatplotlibHelper.GetViridisColor(percentage, out float3 rgb);
            return new Color(rgb.x, rgb.y, rgb.z);
        }

        public static Color GetPlasma(float percentage)
        {
            MatplotlibHelper.GetPlasmaColor(percentage, out float3 rgb);
            return new Color(rgb.x, rgb.y, rgb.z);
        }

        public static Color GetMagma(float percentage)
        {
            MatplotlibHelper.GetMagmaColor(percentage, out float3 rgb);
            return new Color(rgb.x, rgb.y, rgb.z);
        }

        public static Color GetInferno(float percentage)
        {
            MatplotlibHelper.GetInfernoColor(percentage, out float3 rgb);
            return new Color(rgb.x, rgb.y, rgb.z);
        }
    ...
    static class MatplotlibHelper
    {
        static readonly float3x4 Viridis1 = math.float3x4(
            ...
            -0.3308618287255563f,
            -4.634230498983486f,
            0.005407344544966578f,
            1.404613529898575f,
            0.214847559468213f,
            -5.799100973351585f,
            0.3340998053353061f,
            1.384590162594685f,
            0.09509516302823659f,
            -19.33244095627987f
        );
        ...
        static readonly float3x4 Plasma1 = math.float3x4(
            0.05873234392399702f,
            2.176514634195958f,
            -2.689460476458034f,
            6.130348345893603f,
            0.02333670892565664f,
            0.2383834171260182f,
            -7.455851135738909f,
            42.3461881477227f,
            0.5433401826748754f,
        ...
        static readonly float3x4 Magma1 = math.float3x4(
            -0.002136485053939582f,
            0.2516605407371642f,
            8.353717279216625f,
            -27.66873308576866f,
            -0.000749655052795221f,
            0.6775232436837668f,
            -3.577719514958484f,
            14.26473078096533f,
            -0.005386127855323933f,
            2.494026599312351f,
            0.3144679030132573f,
            -13.64921318813922f
        );
        ...
        static readonly float3x4 Inferno1 = math.float3x4(
            0.0002189403691192265f,
            0.1065134194856116f,
            11.60249308247187f,
            -41.70399613139459f,
            0.001651004631001012f,
            0.5639564367884091f,
            -3.972853965665698f,
            17.43639888205313f,
            -0.01948089843709184f,
            3.932712388889277f,
            -15.9423941062914f,
            44.35414519872813f
        );
