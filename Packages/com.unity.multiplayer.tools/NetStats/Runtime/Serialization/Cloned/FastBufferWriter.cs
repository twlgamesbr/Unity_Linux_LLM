...
{
    struct FastBufferWriter : IDisposable
    {
        ...
        /// <summary>
        /// Create a native array containing the contents written to this buffer
        /// </summary>
        /// <param name="allocator">The allocator type to use for the array</param>
        /// <returns>A Native Array containing the contents of this buffer</returns>
