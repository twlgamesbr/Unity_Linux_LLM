...
namespace Unity.Multiplayer.Tools.Editor.MultiplayerToolsWindow.Analytics
{
    ...
    [AnalyticInfo(
        eventName: "mpToolsToolsWindowInteracted",
    ...
    internal class InteractedAnalytic : IAnalytic
    {
        ...
        public bool TryGatherData(out IAnalytic.IData data, out Exception error)
        {
            ...
            {
                data = new InteractedWithEnabledData { toolName = m_ToolName, isToolEnabled = m_IsToolEnabled.Value };
                return true;
            }
            data = new InteractedData { toolName = m_ToolName };
