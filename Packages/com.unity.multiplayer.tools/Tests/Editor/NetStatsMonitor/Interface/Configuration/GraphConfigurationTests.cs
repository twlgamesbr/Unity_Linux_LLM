...
namespace Unity.Multiplayer.Tools.NetStatsMonitor.Tests.Interface.Configuration
{
    class GraphConfigurationTests
    {
        ...
        [TestCase(8, 8)]
        [TestCase(ConfigurationLimits.k_GraphSampleMax, ConfigurationLimits.k_GraphSampleMax)]
        [TestCase(ConfigurationLimits.k_GraphSampleMax + 1, ConfigurationLimits.k_GraphSampleMax)]
