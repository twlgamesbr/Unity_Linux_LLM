...
namespace Unity.Multiplayer.Tools.NetStatsMonitor.Tests.Interface.Configuration
{
    class CounterConfigurationTests
    {
        ...
        [TestCase(8, 8)]
        [TestCase(ConfigurationLimits.k_CounterSampleMax, ConfigurationLimits.k_CounterSampleMax)]
        [TestCase(ConfigurationLimits.k_CounterSampleMax + 1, ConfigurationLimits.k_CounterSampleMax)]
