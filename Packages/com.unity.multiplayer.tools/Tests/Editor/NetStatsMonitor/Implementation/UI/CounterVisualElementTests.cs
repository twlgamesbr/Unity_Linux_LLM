...
namespace Unity.Multiplayer.Tools.NetStatsMonitor.Tests.Implementation.UI
{
    internal class CounterVisualElementTests
    {
        ...
        [OneTimeSetUp]
        public void StoreOriginalCultureSetting()
        {
        ...
        {
            CultureInfo.CurrentCulture = m_OriginalCultureSetting;
        }
            ...
            string expectedDisplayValue)
        {
            ...
            AssertCounterDisplayValue(metric, significantDigits, counterValue, expectedDisplayValue);
            ...
            string expectedDisplayValue)
        {
            ...
            AssertCounterDisplayValue(metric, decimalPlaces, counterValue, expectedDisplayValue);
