    ...
    class TestDataDispatcher
    {
        ...
        public TestDataDispatcher(int seed = 0)
        {
            ...
            m_DataGenerator = new TestDataGenerator(
                new TestDataDefinition(seed != 0 ? seed : m_Random.Next()),
                m_Random,
                m_Random.Next(5, 10)
            );
        ...
        public void DispatchClientFrame()
        {
            ...
            m_Trends.NamedMessagesSent.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.NamedMessagesReceived.Repeat(
                m_Random,
                () =>
                {
                    var namedMessageEvent = m_DataGenerator.GenerateNamedMessageEvent(connection).First();
            ...
            m_Trends.UnnamedMessagesSent.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.UnnamedMessagesReceived.Repeat(
                m_Random,
                () =>
                {
                    var unnamedMessageEvent = m_DataGenerator.GenerateUnnamedMessageEvent(connection).First();
            ...
            m_Trends.NetworkVariableDeltasReceived.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.OwnershipChangeEventsReceived.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.ObjectSpawnEventsReceived.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.ObjectDestroyedEventsReceived.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.RpcEventsReceived.Repeat(
                m_Random,
                () =>
                {
                    var rpcEvent = m_DataGenerator.GenerateRpcEvent(connection).First();
            ...
            m_Trends.ServerLogEventsSent.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.SceneEventsSent.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.SceneEventsReceived.Repeat(
                m_Random,
                () =>
                {
        ...
        public void DispatchServerFrame(uint nbClients = 2)
        {
            ...
            var clientAndServerConnections = Enumerable
                .Range(0, (int)nbClients + 1)
            ...
            m_Trends.NetworkVariableDeltasSent.Repeat(
                m_Random,
                () =>
                {
                    var networkVariableEvents = m_DataGenerator.GenerateNetworkVariableEvent(
            ...
            m_Trends.OwnershipChangeEventsSent.Repeat(
                m_Random,
                () =>
                {
                    var ownershipChangeEvents = m_DataGenerator.GenerateOwnershipChangeEvent(
                        clientAndServerConnections
                    );
            ...
            m_Trends.ObjectSpawnEventsSent.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.ObjectDestroyedEventsSent.Repeat(
                m_Random,
                () =>
                {
            ...
            m_Trends.ServerLogEventsReceived.Repeat(
                m_Random,
                () =>
                {
