...
|[System Inspector reference](editor-system-inspector.md)|Reference for the System Inspector, which is displayed in the [Systems window](editor-systems-window.md) when you select a system.|
