namespace Unity.Scenes.Editor
{
    static class GUIDHelper
    {
        ...
        public static UnityEngine.GUID UnityBuiltinExtraResources = new UnityEngine.GUID(
            "0000000000000000f000000000000000"
        );

        public static bool IsBuiltin(in UnityEngine.GUID g) =>
            g == UnityEditorResources || g == UnityBuiltinResources || g == UnityBuiltinExtraResources;

        public static bool IsBuiltinResources(in UnityEngine.GUID g) => g == UnityBuiltinResources;

        public static bool IsBuiltinExtraResources(in UnityEngine.GUID g) => g == UnityBuiltinExtraResources;
