...
{
    partial class InspectorVisitor : IInspectorPrimitiveVisit, IInspectorContravariantVisit<UnityEngine.Object>
    {
        ...
        {
            if (
                property.HasAttribute<InlineUnityObjectAttribute>()
                || (inspectorContext.IsRootObject && inspectorContext.Root is InspectorElement)
            )
            {
                return false;
            }
        ...
        bool VisitNull<TContainer, TValue>(
            InspectorContext inspectorContext,
            IProperty<TContainer> property,
            ref TValue value,
            PropertyPath path
