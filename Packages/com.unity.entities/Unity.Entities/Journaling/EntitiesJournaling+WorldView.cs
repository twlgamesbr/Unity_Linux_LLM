...
namespace Unity.Entities
{
    partial class EntitiesJournaling
    {
        ...
        public readonly unsafe struct WorldView : IEquatable<WorldView>
        {
            [NativeDisableUnsafePtrRestriction]
            readonly ulong* m_SequenceNumberPtr;
            ...
            [ExcludeFromBurstCompatTesting("Returns managed object")]
            public override bool Equals(object obj) => obj is WorldView type ? Equals(type) : false;
            ...
            [ExcludeFromBurstCompatTesting("Returns managed object")]
            public override string ToString() => $"{Name}:{SequenceNumber}";
        }
    }
}
#endif
