...
namespace Unity.Entities
{
    partial class EntitiesJournaling
    {
        ...
        public readonly unsafe struct ComponentTypeView : IEquatable<ComponentTypeView>
        {
            [NativeDisableUnsafePtrRestriction]
            internal readonly TypeIndex* m_TypeIndexPtr;
            ...
            public override bool Equals(object obj) => obj is ComponentTypeView type ? Equals(type) : false;

            public override int GetHashCode() => TypeIndex.GetHashCode();

            public static bool operator ==(ComponentTypeView lhs, ComponentTypeView rhs) =>
                lhs.TypeIndex == rhs.TypeIndex;

            public static bool operator !=(ComponentTypeView lhs, ComponentTypeView rhs) => !(lhs == rhs);

            [ExcludeFromBurstCompatTesting("Returns managed object")]
            public override string ToString() => $"{Name}:{TypeIndex}";
        }
    }
}
#endif
