...
namespace Unity.Entities.Internal
{
    ...
    public static partial class InternalCompilerInterface
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool DoesEntityExist(
            ref EntityStorageInfoLookup entityStorageInfoLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentLookup<T> GetComponentLookup<T>(
        ...
        public static RefRO<T> GetComponentRefROOptional<T>(ref ComponentLookup<T> componentLookup, Entity entity)
            where T : unmanaged, IComponentData
        {
            bool _ = componentLookup.TryGetRefRO(entity, out var outRef);
            return outRef;
        }
        ...
        public static RefRW<T> GetComponentRefRWOptional<T>(ref ComponentLookup<T> componentLookup, Entity entity)
            where T : unmanaged, IComponentData
        {
            bool _ = componentLookup.TryGetRefRW(entity, out var outRef);
            return outRef;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RefRO<T> GetComponentROAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RefRW<T> GetComponentRWAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetComponentAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryGetComponentAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            Entity entity,
            out T result
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetComponentAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            T component,
            Entity entity
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool HasComponentAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsComponentEnabledAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetComponentEnabledAfterCompletingDependency<T>(
            ref ComponentLookup<T> componentLookup,
            ref SystemState state,
            Entity entity,
            bool value
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DynamicBuffer<T> GetBufferAfterCompletingDependency<T>(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool HasBufferAfterCompletingDependency<T>(
            ref BufferLookup<T> bufferLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsBufferEnabledAfterCompletingDependency<T>(
            ref BufferLookup<T> bufferLookup,
            ref SystemState state,
            Entity entity
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetBufferEnabledAfterCompletingDependency<T>(
            ref BufferLookup<T> bufferLookup,
            ref SystemState state,
            Entity entity,
            bool value
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentTypeHandle<T> GetComponentTypeHandle<T>(
            ref ComponentTypeHandle<T> componentTypeHandle,
            ref SystemState state
        )
            where T : unmanaged, IComponentData
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BufferTypeHandle<T> GetBufferTypeHandle<T>(
        ...
        public static SharedComponentTypeHandle<T> GetSharedComponentTypeHandle<T>(
            ref SharedComponentTypeHandle<T> sharedComponentTypeHandle,
            ref SystemState state
        )
        ...
        public static unsafe ref T UnsafeAsRef<T>(IntPtr value)
            where T : struct
        {
        ...
        public static unsafe IntPtr AddressOf<T>(ref T value)
            where T : struct
        {
        ...
        public static unsafe T GetComponentData<T>(
            EntityManager manager,
            Entity entity,
            TypeIndex typeIndex,
            out T originalComponent
        )
            where T : unmanaged, IComponentData
        {
        ...
        public static unsafe void WriteComponentData<T>(
            EntityManager manager,
            Entity entity,
            TypeIndex typeIndex,
            ref T lambdaComponent,
            ref T originalComponent
        )
            where T : unmanaged, IComponentData
        {
            var access = manager.GetCheckedEntityDataAccess();
            ...
            if (
                UnsafeUtility.MemCmp(
                    UnsafeUtility.AddressOf(ref lambdaComponent),
                    UnsafeUtility.AddressOf(ref originalComponent),
                    sizeOf
                ) != 0
        ...
        public static void UnsafeCreateGatherEntitiesResult(
            ref EntityQuery query,
            out InternalGatherEntitiesResult result
        ) => query.GatherEntitiesToArray(out result);

        public static void UnsafeReleaseGatheredEntities(
            ref EntityQuery query,
            ref InternalGatherEntitiesResult result
        ) => query.ReleaseGatheredEntities(ref result);

        public static unsafe Entity UnsafeGetEntityFromGatheredEntities(
            ref InternalGatherEntitiesResult result,
            int entityIndex
        ) => result.EntityBuffer[entityIndex];

        public static unsafe IntPtr UnsafeGetChunkNativeArrayReadOnlyIntPtr<T>(
            ArchetypeChunk chunk,
            ref ComponentTypeHandle<T> typeHandle
        )
            where T : unmanaged, IComponentData => (IntPtr)chunk.GetRequiredComponentDataPtrRO(ref typeHandle);

        public static unsafe IntPtr UnsafeGetChunkNativeArrayIntPtr<T>(
            ArchetypeChunk chunk,
            ref ComponentTypeHandle<T> typeHandle
        )
            where T : unmanaged, IComponentData => (IntPtr)chunk.GetRequiredComponentDataPtrRW(ref typeHandle);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool UnsafeTryGetNextEnabledBitRange(
            v128 mask,
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe IntPtr UnsafeGetChunkNativeArrayReadOnlyIntPtrWithoutChecks<T>(
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe IntPtr UnsafeGetChunkNativeArrayIntPtrWithoutChecks<T>(
            in ArchetypeChunk chunk,
            ref ComponentTypeHandle<T> typeHandle
        )
            where T : unmanaged, IComponentData
        {
            ...
            if (Hint.Unlikely(chunk.m_EntityComponentStore->m_RecordToJournal != 0))
                chunk.JournalAddRecordGetComponentDataRW(
                    ref typeHandle,
                    ptr,
                    typeHandle.m_LookupCache.ComponentSizeOf * chunk.Count
                );
#endif
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UncheckedRefRO<T> UnsafeGetUncheckedRefRO<T>(
            IntPtr ptr,
            int index,
            ref ComponentTypeHandle<T> typeHandle
        )
        ...
        public static UncheckedRefRO<T> UnsafeGetUncheckedRefRO<T>(IntPtr ptr, int index)
            where T : unmanaged, IComponentData => new(ptr + UnsafeUtility.SizeOf<T>() * index);
#endif
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UncheckedRefRW<T> UnsafeGetUncheckedRefRW<T>(
            IntPtr ptr,
            int index,
            ref ComponentTypeHandle<T> typeHandle
        )
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe RefRO<T> GetRefRO<T>(IntPtr ptr, int index, ref ComponentTypeHandle<T> typeHandle)
            where T : unmanaged, IComponentData
        {
...
#if !ENABLE_UNITY_COLLECTIONS_CHECKS
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe RefRO<T> GetRefRO<T>(IntPtr ptr, int index)
            where T : unmanaged, IComponentData => new((byte*)ptr + UnsafeUtility.SizeOf<T>() * index);
#endif
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe RefRW<T> GetRefRW<T>(IntPtr ptr, int index, ref ComponentTypeHandle<T> typeHandle)
            where T : unmanaged, IComponentData
        {
...
#if !ENABLE_UNITY_COLLECTIONS_CHECKS
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe RefRW<T> GetRefRW<T>(IntPtr ptr, int index)
            where T : unmanaged, IComponentData => new((byte*)ptr + UnsafeUtility.SizeOf<T>() * index);
#endif
        ...
        /// </summary>
        public readonly unsafe struct UncheckedRefRO<T>
            where T : unmanaged, IComponentData
        {
        ...
        /// </summary>
        public readonly unsafe struct UncheckedRefRW<T>
            where T : unmanaged, IComponentData
        {
            private readonly IntPtr _ptr;
        ...
        public static unsafe IntPtr UnsafeGetChunkEntityArrayIntPtr(
            ArchetypeChunk chunk,
            EntityTypeHandle typeHandle
        ) => (IntPtr)chunk.GetEntityDataPtrRO(typeHandle);

        public static unsafe IntPtr UnsafeGetEntityArrayIntPtr(NativeArray<Entity> array) =>
            (IntPtr)array.GetUnsafeReadOnlyPtr();

        public static unsafe T UnsafeGetCopyOfNativeArrayPtrElement<T>(IntPtr nativeArrayPtr, int elementIndex)
            where T : unmanaged => *((T*)nativeArrayPtr + elementIndex);

        public static unsafe ref T UnsafeGetRefToNativeArrayPtrElement<T>(IntPtr nativeArrayPtr, int elementIndex)
            where T : unmanaged => ref UnsafeUtility.AsRef<T>((T*)nativeArrayPtr + elementIndex);
        ...
        public static class JobChunkInterface
        {
            ...
            public static unsafe JobHandle Schedule<T>(T jobData, EntityQuery query, JobHandle dependsOn)
                where T : struct, IJobChunk
            {
                return JobChunkExtensions.ScheduleInternal(
                    ref jobData,
                    query,
                    dependsOn,
                    ScheduleMode.Single,
            ...
            public static unsafe JobHandle ScheduleByRef<T>(ref T jobData, EntityQuery query, JobHandle dependsOn)
                where T : struct, IJobChunk
            {
                return JobChunkExtensions.ScheduleInternal(
                    ref jobData,
            ...
            public static unsafe JobHandle ScheduleParallel<T>(T jobData, EntityQuery query, JobHandle dependsOn)
        ...
        public static void MergeWith(ref UnsafeList<ComponentType> mergeThese, ref UnsafeList<ComponentType> withThese)
        {
            ...
            var componentTypeToAccessMode = new NativeHashMap<int, ComponentType.AccessMode>(
                initialCapacity: mergeThese.Length,
                Allocator.Temp
            );
            ...
            foreach (var componentType in mergeThese)
            {
                ...
                else
                {
                    if (
                        (
                            accessMode == ComponentType.AccessMode.Exclude
        ...
        internal static InvalidOperationException ThrowCodeGenException() =>
