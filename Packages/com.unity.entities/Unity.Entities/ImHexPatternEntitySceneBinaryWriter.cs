...
namespace Unity.Entities
{
    public struct ImHexPatternEntitySceneBinaryWriter : IDisposable
    {
        ...
        internal static class TypeHelper
        {
            ...
            {
                "addr", "addressof", "as", "be", "bitfield", "break", "continue", "else", "enum", "false", "fn", "for", "from", "if", "import",
                "in", "le", "let", "match", "namespace", "null", "out", "parent", "ref", "return", "struct", "this", "true", "type", "union",
                "using", "while",
            };
            ...
            public static string GetImHexSupportedName(string name)
            {
                ...
                if (commaIdx >= 0 && commaIdx < end) end = commaIdx;
                if (bracketIdx >= 0 && bracketIdx < end) end = bracketIdx;
