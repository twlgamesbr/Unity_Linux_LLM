...
namespace Unity.Entities
{
    ...
    {
        [BurstCompile]
        public static void AddComponentEntitiesBatch(
            EntityComponentStore* entityComponentStore,
            UnsafeList<EntityBatchInChunk>* entityBatchList,
            TypeIndex typeIndex
        )
        {
        ...
        [BurstCompile]
        public static void AddComponentsEntitiesBatch(
            EntityComponentStore* entityComponentStore,
            UnsafeList<EntityBatchInChunk>* entityBatchList,
        ...
        [BurstCompile]
        public static bool AddComponentEntity(
            EntityComponentStore* entityComponentStore,
            Entity* entity,
            TypeIndex typeIndex
        )
        ...
        [BurstCompile]
        public static void AddComponentsEntity(
            EntityComponentStore* entityComponentStore,
            Entity* entity,
            in ComponentTypeSet typeSet
        )
        ...
        [BurstCompile]
        public static void AddComponentChunks(
            EntityComponentStore* entityComponentStore,
        ...
        [BurstCompile]
        public static void AddComponentQuery(
            EntityComponentStore* entityComponentStore,
        ...
        [BurstCompile]
        public static void AddComponentsQuery(
            EntityComponentStore* entityComponentStore,
            EntityQueryImpl* queryImpl,
            in ComponentTypeSet typeSet
        )
        ...
        [BurstCompile]
        public static void RemoveComponentsEntity(
            EntityComponentStore* entityComponentStore,
            Entity* entity,
            in ComponentTypeSet typeSet
        )
        ...
        [BurstCompile]
        public static void RemoveComponentEntitiesBatch(
            EntityComponentStore* entityComponentStore,
            UnsafeList<EntityBatchInChunk>* entityBatchList,
            TypeIndex typeIndex
        )
        ...
        [BurstCompile]
        public static void RemoveComponentsEntitiesBatch(
            EntityComponentStore* entityComponentStore,
            UnsafeList<EntityBatchInChunk>* entityBatchList,
            in ComponentTypeSet typeSet
        )
        ...
        [BurstCompile]
        public static void RemoveComponentChunks(
            EntityComponentStore* entityComponentStore,
            ArchetypeChunk* chunks,
            int chunkCount,
            TypeIndex typeIndex
        ...
        [BurstCompile]
        public static void RemoveComponentQuery(
            EntityComponentStore* entityComponentStore,
            EntityQueryImpl* queryImpl,
            TypeIndex typeIndex
        )
        ...
        [BurstCompile]
        public static void RemoveComponentsQuery(
            EntityComponentStore* entityComponentStore,
            EntityQueryImpl* queryImpl,
            in ComponentTypeSet typeSet
        )
        ...
        [BurstCompile]
        public static void AddSharedComponentDataIndexWithBurst(
            EntityComponentStore* entityComponentStore,
            Entity* entities,
            int entityCount,
        ...
        )
        {
            for (int i = 0; i < entityCount; ++i)
            {
                ...
                entityComponentStore->SetSharedComponentDataIndex(
                    entities[i],
                    componentType,
        ...
        [BurstCompile]
        public static void SetSharedComponentDataIndexWithBurst(
            EntityComponentStore* entityComponentStore,
            Entity* entities,
            int entityCount,
            in ComponentType componentType,
        ...
        [BurstCompile]
        public static void AddSharedComponentChunks(
            EntityComponentStore* entityComponentStore,
            ArchetypeChunk* chunks,
            int chunkCount,
        ...
        {
            entityComponentStore->AddComponent(
                chunks,
                chunkCount,
                ComponentType.FromTypeIndex(componentTypeIndex),
                sharedComponentIndex
            );
        }

        [BurstCompile]
        public static void AddSharedComponentQuery(
            EntityComponentStore* entityComponentStore,
            EntityQueryImpl* queryImpl,
            TypeIndex componentTypeIndex,
            int sharedComponentIndex
        ...
        [BurstCompile]
        public static void MoveEntityArchetype(
            EntityComponentStore* entityComponentStore,
            Entity* entity,
            void* dstArchetype
        )
        ...
        [BurstCompile]
        public static void SetChunkComponent(
            EntityComponentStore* entityComponentStore,
            ArchetypeChunk* chunks,
            int chunkCount,
            void* componentData,
        ...
        [BurstCompile]
        public static void DestroyChunksQuery(
            EntityComponentStore* entityComponentStore,
            EntityQueryImpl* queryImpl,
        ...
        [BurstCompile]
        public static void InstantiateEntity(
            EntityComponentStore* entityComponentStore,
            Entity* srcEntity,
