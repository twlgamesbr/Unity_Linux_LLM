...
public static class IfeCompilerMessages
{
    ...
    public static void SGFE002(
        SystemDescription systemDescription,
        string propertyAccessorFullName,
    ...
    public static void SGFE007(
        SystemDescription systemDescription,
        int numSharedComponentFilters,
        Location errorLocation
    )
    {
        systemDescription.LogError(
    ...
    public static void SGFE009(
        SystemDescription systemDescription,
        string valueTypeComponentFullName,
        Location errorLocation
    )
    {
