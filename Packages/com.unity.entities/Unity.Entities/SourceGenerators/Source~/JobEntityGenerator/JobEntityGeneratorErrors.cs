...
public static class JobEntityGeneratorErrors
{
    ...
    public static void SGJE0006(
        ISourceGeneratorDiagnosable context,
        Location location,
        string jobEntityTypeName,
        string methodSignature,
        string nonIntegerEntityQueryParameter,
    ...
    public static void SGJE0008(
        ISourceGeneratorDiagnosable context,
        Location location,
        string jobEntityTypeName,
        List<IMethodSymbol> userDefinedExecuteMethods
    )
    {
        context.LogError(
            nameof(SGJE0008),
    ...
    public static void SGJE0023(
        ISourceGeneratorDiagnosable diagnosable,
        Location location,
        string parameterTypeFullName,
        string parameterAccessibility,
        string jobEntityTypeFullName,
        string jobAccessibility
    )
    {
        diagnosable.LogError(
            nameof(SGJE0023),
