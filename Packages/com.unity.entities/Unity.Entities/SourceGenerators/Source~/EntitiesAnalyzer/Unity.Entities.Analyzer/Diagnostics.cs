...
namespace Unity.Entities.Analyzer
{
    ...
    public static class EntitiesDiagnostics
    {
        ...
        public static readonly DiagnosticDescriptor k_Ea0001Descriptor = new DiagnosticDescriptor(
            ID_EA0001,
            "You may only access BlobAssetStorage by (non-readonly) ref",
        ...
        public static readonly DiagnosticDescriptor k_Ea0002Descriptor = new DiagnosticDescriptor(
            ID_EA0002,
            "Potentially harmful construction of a BlobAsset with keywords `new` or `default`",
        ...
        public static readonly DiagnosticDescriptor k_Ea0003Descriptor = new DiagnosticDescriptor(
            ID_EA0003,
            "You cannot use the BlobBuilder to build a type containing Non-Blob References",
        ...
        public static readonly DiagnosticDescriptor k_Ea0004Descriptor = new DiagnosticDescriptor(
            ID_EA0004,
            "SystemAPI member use is not permitted outside of a system type (SystemBase or ISystem)",
        ...
        public static readonly DiagnosticDescriptor k_Ea0005Descriptor = new DiagnosticDescriptor(
            ID_EA0005,
            "This SystemAPI member use is not permitted inside an Entities.ForEach lambda",
        ...
        public static readonly DiagnosticDescriptor k_Ea0006Descriptor = new DiagnosticDescriptor(
            ID_EA0006,
            "SystemAPI member use is not permitted in a static method",
        ...
        public static readonly DiagnosticDescriptor k_Ea0007Descriptor = new DiagnosticDescriptor(
            ID_EA0007,
            "Type is not marked partial",
        ...
        public static readonly DiagnosticDescriptor k_Ea0008Descriptor = new DiagnosticDescriptor(
            ID_EA0008,
            "Parent Type is not marked partial",
        ...
        public static readonly DiagnosticDescriptor k_Ea0009Descriptor = new DiagnosticDescriptor(
            ID_EA0009,
            "You may only access BlobAssetStorage by (non-readonly) ref",
        ...
        public static readonly DiagnosticDescriptor k_Ea0010Descriptor = new DiagnosticDescriptor(
            ID_EA0010,
            "Containing Type is missing BurstCompile attribute",
        ...
        public static readonly DiagnosticDescriptor k_Ea0011Descriptor = new DiagnosticDescriptor(
            ID_EA0011,
            "Missing terminator",
        ...
        public static readonly DiagnosticDescriptor k_Ea0012Descriptor = new DiagnosticDescriptor(
            ID_EA0012,
        ...
        public static readonly DiagnosticDescriptor k_Ea0013Descriptor = new DiagnosticDescriptor(
            ID_EA0013,
            "Chain not properly terminated",
        ...
        public static readonly DiagnosticDescriptor k_Ea0014Descriptor = new DiagnosticDescriptor(
            ID_EA0014,
        ...
        public static readonly DiagnosticDescriptor k_Ea0015Descriptor = new DiagnosticDescriptor(
            ID_EA0015,
        ...
        public static readonly DiagnosticDescriptor k_Ea0016Descriptor = new DiagnosticDescriptor(
            ID_EA0016,
