...
namespace Unity.Entities.Analyzer
{
    ...
    public class TypeTests
    {
        ...
        public async Task SystemBase()
        {
            ...
            var expected = VerifyTypeAnalyzer
                .Diagnostic(EntitiesDiagnostics.k_Ea0007Descriptor)
                .WithLocation(0)
                .WithArguments("SystemBase", "global::TestSystem");
        ...
        public async Task ISystem()
        {
            ...
            var expected = VerifyTypeAnalyzer
                .Diagnostic(EntitiesDiagnostics.k_Ea0007Descriptor)
                .WithLocation(0)
                .WithArguments("ISystem", "global::TestSystem");
            await VerifyTypeAnalyzer.VerifyCodeFixAsync(test, expected, fixedSource);
        }
        ...
        public async Task JobEntity()
        {
            ...
            var expected = VerifyTypeAnalyzer
                .Diagnostic(EntitiesDiagnostics.k_Ea0007Descriptor)
                .WithLocation(0)
                .WithArguments("IJobEntity", "global::TestJob");
            await VerifyTypeAnalyzer.VerifyCodeFixAsync(test, expected, fixedSource);
        }
        ...
        public async Task JobEntityParent()
        {
            ...
            var expectedA = VerifyTypeAnalyzer
                .Diagnostic(EntitiesDiagnostics.k_Ea0008Descriptor)
                .WithLocation(0)
                .WithArguments("IJobEntity", "global::A.B.TestJob", "global::A");
            var expectedB = VerifyTypeAnalyzer
                .Diagnostic(EntitiesDiagnostics.k_Ea0008Descriptor)
                .WithLocation(1)
                .WithArguments("IJobEntity", "global::A.B.TestJob", "global::A.B");
        ...
        public async Task RefSystemState()
        {
            ...
            var expected = VerifyTypeAnalyzer
                .Diagnostic(EntitiesDiagnostics.k_Ea0016Descriptor)
                .WithLocation(0)
                .WithArguments("RefSystemState", "global::TestSystem");
