...
public static partial class InternalCompilerInterface
{
    ...
    public static bool TryGetComponentAfterCompletingDependency<T>(
        ...
        where T : unmanaged, IComponentData => throw new Exception();
    ...
    public static SharedComponentTypeHandle<T> GetSharedComponentTypeHandle<T>(
        ...
        where T : struct, ISharedComponentData => default;

    public static void MergeWith(
        ref UnsafeList<ComponentType> componentTypes,
        ref UnsafeList<ComponentType> addThese
    ) { }
    ...
    public readonly struct UncheckedRefRO<T> : IComponentData
        where T : unmanaged, IComponentData
    {
        public T ValueRO => default;
    }

    public readonly struct UncheckedRefRW<T>
        where T : unmanaged, IComponentData
    {
    ...
    public static JobChunkRunWithoutJobSystemDelegateLimitEntities BurstCompile(
        JobChunkRunWithoutJobSystemDelegateLimitEntities d
    ) => default;
    ...
    public delegate void JobChunkRunWithoutJobSystemDelegateLimitEntities(
    ...
    public static unsafe ref T UnsafeAsRef<T>(IntPtr value)
        where T : struct => throw new Exception();
    ...
    public static unsafe T GetComponentData<T>(
        ...
        where T : struct, IComponentData => throw new Exception();
    ...
    public static unsafe ref T UnsafeGetRefToNativeArrayPtrElement<T>(IntPtr nativeArrayPtr, int elementIndex)
        where T : unmanaged => throw new Exception();
    ...
    public static class JobChunkInterface
    {
        ...
        public static JobHandle Schedule<T>(T jobData, EntityQuery query, JobHandle dependsOn)
...
#pragma warning restore 618
        ...
        public static void RunByRefWithoutJobs<T>(
            ref T jobData,
            EntityQuery query,
            NativeArray<Entity> limitToEntityArray
        )
        ...
        public static unsafe void RunWithoutJobsInternal<T>(
            ref T jobData,
            ref EntityQuery query,
            IntPtr limitToEntityArrayPtr,
            int limitToEntityArrayLength
    ...
    public static void UnsafeRunJobChunk<T>(
        ref T jobData,
        EntityQuery query,
