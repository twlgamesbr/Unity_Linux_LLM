...
namespace Unity.Entities
{
    ...
    public unsafe struct BlobBuilder : IDisposable
    {
    ...
    public unsafe struct BlobAssetReference<T>
        where T : unmanaged
    {
    ...
    public unsafe struct BlobArray<T>
        where T : struct { }

    [MayOnlyLiveInBlobStorage]
    public unsafe struct BlobPtr<T>
        where T : struct { }
    ...
    public unsafe struct ArchetypeChunk : IEquatable<ArchetypeChunk>
    {
        ...
        public NativeArray<T> GetNativeArray<T>(ref ComponentTypeHandle<T> chunkComponentTypeHandle)
        ...
        public EnabledMask GetEnabledMask<T>(ref BufferTypeHandle<T> chunkBufferTypeHandle)
            where T : unmanaged, IBufferElementData, IEnableableComponent => default;

        public EnabledMask GetEnabledMask(ref DynamicComponentTypeHandle chunkComponentTypeHandle) => default;
    ...
    public class World
    {
        public T GetOrCreateSystemManaged<T>()
            where T : ComponentSystemBase => default;
    }
    ...
    public struct DynamicBuffer<T> : IQueryTypeParameter
        where T : unmanaged
    {
        public T this[int i]
        {
    ...
    public static class EntityQueryExtentions
    {
        public static T GetSingleton<T>(this EntityQuery query)
            where T : class, IComponentData => default;
    }
    ...
    public static class SystemAPI
    {
        ...
        public static bool IsComponentEnabled<T>(Entity entity)
            where T : unmanaged, IComponentData, IEnableableComponent => throw new Exception();

        public static void SetComponentEnabled<T>(Entity entity, bool value)
            where T : unmanaged, IComponentData, IEnableableComponent => throw new Exception();
    }

    public struct QueryEnumerable<T> : IEnumerable<T>
        where T : struct
    {
        ...
        public QueryEnumerable<T> WithSharedComponentFilter<T1, T2>(T1 sharedComp1, T2 sharedComp2) =>
            throw ThrowCodeGenException();
    ...
    public struct EntityManager
    {
        ...
        public void AddComponentData<T>(Entity entity, T componentData)
...
namespace Unity.Jobs
{
    ...
    {
        public static JobHandle Schedule<T>(this T job, JobHandle dependency)
