...
namespace Unity.Entities.SourceGen.SystemGenerator.Common
{
    ...
    {
        public static void LogError<TDiagnosable>(
            this TDiagnosable diagnosable,
            string errorCode,
            string title,
            string errorMessage,
            Location location,
            ...
            where TDiagnosable : ISourceGeneratorDiagnosable
        {
        ...
        public static void LogWarning<TDiagnosable>(
            this TDiagnosable diagnosable,
            string errorCode,
            string title,
            string errorMessage,
        ...
        public static void LogInfo<TDiagnosable>(
            this TDiagnosable diagnosable,
            string errorCode,
            string title,
            string errorMessage,
