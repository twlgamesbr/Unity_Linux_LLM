...
{
    [Serializable]
    internal struct SceneSectionReferencedUnityObjects
        : ISharedComponentData,
            IEquatable<SceneSectionReferencedUnityObjects>
#if !UNITY_EDITOR
            ,
            IRefCounted
#endif
    {
        ...
        public bool Equals(SceneSectionReferencedUnityObjects other) =>
            _sceneBundleHandles.Equals(other._sceneBundleHandles);
