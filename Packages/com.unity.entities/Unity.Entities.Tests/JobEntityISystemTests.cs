...
namespace Unity.Entities.Tests
{
    ...
    public unsafe partial class JobEntityISystemTests : ECSTestsFixture
    {
        ...
        public void SetUp()
        {
            ...
            var myArch = m_Manager.CreateArchetype(
                ...
                ComponentType.ChunkComponent<EcsTestData6>());
            ...
            var chunk = m_Manager.GetChunk(TestEntity);
            m_Manager.SetChunkComponentData(chunk, new EcsTestData6 { value = 6 });
        ...
        [Test]
        public void WithEntityQueryOption_MetaChunks() => GetTestSystemUnsafe().WithEntityQueryOption_MetaChunks(ref GetSystemStateRef());
    ...
    [WithOptions(EntityQueryOptions.IncludeMetaChunks)]
    partial struct WithEntityQueryOption_MetaChunksJob : IJobEntity
    {
        void Execute(ref EcsTestData6 data, in ChunkHeader chunkHeader)
        {
            data.value = 42;
        }
    }
    ...
    partial struct JobEntityISystemTestsSystem : ISystem
    {
        ...
        public void WithEntityQueryOption_MetaChunks(ref SystemState state)
        {
            new WithEntityQueryOption_MetaChunksJob().Run();
            Assert.AreEqual(state.EntityManager.GetChunkComponentData<EcsTestData6>(JobEntityISystemTests.TestEntity).value, 42);
        }
