...
namespace Unity.Editor.Legacy
{
            ...
            IVisitPropertyAdapter<float4x4>
    {
        public void Visit<TContainer>(
            in VisitContext<TContainer, Hash128> context,
        ...
        public void Visit<TContainer>(
            in VisitContext<TContainer, quaternion> context,
            ref TContainer container,
        ...
        )
        {
            ...
            {
                CustomEditorGUILayout.Vector4Label(
                    GetDisplayName(context.Property),
                    value.value,
                    IsMixedValue("value", value.value)
                );
            }
        }

        public void Visit<TContainer>(
            in VisitContext<TContainer, float2> context,
            ref TContainer container,
            ref float2 value
        )
        {
            CustomEditorGUILayout.Vector2Label(
                GetDisplayName(context.Property),
                value,
                IsMixedValue(context.Property.Name, value)
            );
        }

        public void Visit<TContainer>(
            in VisitContext<TContainer, float3> context,
            ref TContainer container,
            ref float3 value
        )
        {
            CustomEditorGUILayout.Vector3Label(
                GetDisplayName(context.Property),
                value,
                IsMixedValue(context.Property.Name, value)
            );
        ...
        public void Visit<TContainer>(
            in VisitContext<TContainer, float4> context,
            ref TContainer container,
            ref float4 value
        )
        {
        ...
        public void Visit<TContainer>(
            in VisitContext<TContainer, float2x2> context,
            ref TContainer container,
            ref float2x2 value
        )
        {
        ...
        public void Visit<TContainer>(
            in VisitContext<TContainer, float3x3> context,
            ref TContainer container,
            ref float3x3 value
        )
        {
        ...
        public void Visit<TContainer>(
            in VisitContext<TContainer, float4x4> context,
            ref TContainer container,
            ref float4x4 value
        )
        {
        ...
        bool2 IsMixedValue(string name, float2 value)
        {
            ...
            {
                return new bool2(IsMixedValue("x", value.x), IsMixedValue("y", value.y));
            }
        }
        ...
        bool3 IsMixedValue(string name, float3 value)
        {
            using (MakePathScope(name))
            {
                return new bool3(IsMixedValue("x", value.x), IsMixedValue("y", value.y), IsMixedValue("z", value.z));
            }
        }
