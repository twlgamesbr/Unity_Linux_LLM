...
namespace Unity.Entities.Editor
{
    class ComponentRelationshipWorldView : VisualElement
    {
        ...
        static readonly string k_MoreLabel = L10n.Tr(
            "More systems are matching this component. You can use the search to filter systems by name."
        );
        ...
        public ComponentRelationshipWorldView(ComponentRelationshipWorldViewData data)
        {
            ...
            m_EntitiesSection
                .Q<VisualElement>(className: UssClasses.FoldoutWithActionButton.Icon)
                .AddToClassList(UssClasses.QueryWithEntities.EntityIcon);

            m_SystemQueriesListView = new SystemQueriesListView(
            ...
            m_SystemQueriesListView
                .Q(className: UssClasses.FoldoutWithoutActionButton.Icon)
                .AddToClassList(UssClasses.SystemListView.SystemIcon);
        ...
        public void Update()
        {
            ...
            foreach (
                var queryView in m_SystemQueriesListView
                    .Q<FoldoutWithoutActionButton>()
                    .Query(className: "foldout-with-action-button__name")
                    .ToList()
            )
            {
        ...
        public bool IsEmpty =>
            m_Data.QueryWithEntitiesViewData.TotalEntityCount == 0
            && m_Data.ComponentMatchingSystems.Systems.Count == 0;
    }
}
