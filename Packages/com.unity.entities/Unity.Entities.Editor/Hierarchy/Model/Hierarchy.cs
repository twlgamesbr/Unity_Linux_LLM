...
namespace Unity.Entities.Editor
{
    ...
    class HierarchyConfiguration
    {
        ...
        /// </summary>
        [CreateProperty]
        public Hierarchy.UpdateModeType UpdateMode = Hierarchy.UpdateModeType.Asynchronous;

        /// <summary>
        /// The minimum number of milliseconds between update ticks. This is used to throttle the refresh rate to a reasonable value.
        /// </summary>
        [CreateProperty]
        public int MinimumMillisecondsBetweenHierarchyUpdateCycles = 16;
        ...
        /// </remarks>
        [CreateProperty]
        public int MaximumMillisecondsPerEditorUpdate = 16;
        ...
        /// </remarks>
        [CreateProperty]
        public int EntityChangeIntegrationBatchSize = 100000;
        ...
        /// </remarks>
        [CreateProperty]
        public int GameObjectChangeIntegrationBatchSize = 100;
        ...
        /// </remarks>
        [CreateProperty]
        public int ExportImmutableBatchSize = 100000;

        /// <summary>
        /// A flag to disable considering unnamed nodes when searching. This will accelerate performance.
        /// </summary>
        [CreateProperty]
        public bool ExcludeUnnamedNodesForSearch = false;

        [CreateProperty]
        public bool AdvancedSearch = true;
    }
    ...
    {
        [CreateProperty]
        public Dictionary<string, HierarchyNodesState> Nodes = new Dictionary<string, HierarchyNodesState>();
    ...
    class HierarchyStats
    {
        ...
        /// </summary>
        [CreateProperty, UsedImplicitly]
        public int UpdateSkipCount { get; private set; }
        ...
        /// </summary>
        [CreateProperty, UsedImplicitly]
        public int LastUpdateCount { get; private set; } = -1;

        /// <summary>
        /// The number of ticks the last update cycle skipped.
        /// </summary>
        [CreateProperty, UsedImplicitly]
        public int LastUpdateSkipCount { get; private set; } = -1;

        /// <summary>
        /// The current running timer for the update.
        /// </summary>
        [CreateProperty, UsedImplicitly]
        public long LastUpdateTime { get; private set; } = -1;
        ...
        /// </summary>
        [CreateProperty, UsedImplicitly]
        public float AverageUpdateCount => m_AverageUpdateCount;
        ...
        /// </summary>
        [CreateProperty, UsedImplicitly]
        public float AverageUpdateSkipCount => m_AverageUpdateSkipCount;
        ...
        /// </summary>
        [CreateProperty, UsedImplicitly]
        public float AverageUpdateTime => m_AverageUpdateTime;
        ...
        internal void FinishUpdateCounter()
        {
            ...
            ExponentialMovingAverage.Add(
                ref m_AverageUpdateCount,
                UpdateCount,
                ref m_AverageUpdateCountVariance,
                k_RollingAveragePeriod
            );
            ExponentialMovingAverage.Add(
                ref m_AverageUpdateTime,
                UpdateTime,
                ref m_AverageUpdateTimeVariance,
                k_RollingAveragePeriod
            );
        ...
        internal void FinishSkippedUpdateCounter()
        {
            ...
            ExponentialMovingAverage.Add(
                ref m_AverageUpdateSkipCount,
                UpdateSkipCount,
                ref m_AverageUpdateSkipCountVariance,
                k_RollingAveragePeriod
            );
    ...
    class Hierarchy : IDisposable
    {
        ...
        public HierarchyState State
        {
            ...
            set
            {
                ...
                m_HierarchyNodes.SetSerializableState(
                    null != m_World ? value.GetHierarchyNodesSerializableState(m_World.Name) : new HierarchyNodesState()
                );
            }
        }
        ...
        public Hierarchy(Allocator allocator, DataMode currentMode)
            : this(null, allocator, currentMode) { }
        ...
        public Hierarchy(World world, Allocator allocator, DataMode currentMode)
        {
            ...
            // Internal features.
            m_Updater = new HierarchyUpdater(
                m_HierarchyNodeStore,
                m_HierarchyNodeImmutableStore,
        ...
        public HierarchyNodes GetNodes() => m_HierarchyNodes;
        ...
        public float GetEstimatedProgress() => m_Updater.EstimatedProgress;
        ...
        public void SetWorld(World world)
        {
            ...
            m_HierarchyNodes.SetSerializableState(
                null != m_World ? m_State.GetHierarchyNodesSerializableState(m_World.Name) : new HierarchyNodesState()
            );
        }
        ...
        public void Update(bool isVisible)
        {
            ...
            m_Updater.SetEntityChangeTrackerMode(
                OperationMode == OperationModeType.Normal
            ...
            if (
                m_Updater.Step == HierarchyUpdater.UpdateStep.End
                && m_UpdateThrottleTimer.ElapsedMilliseconds
                    < m_Configuration.MinimumMillisecondsBetweenHierarchyUpdateCycles
            )
            {
                ...
                case UpdateModeType.Synchronous:
                    {
                        ...
                        if (
                            m_Updater.Step != HierarchyUpdater.UpdateStep.Start
                            && m_Updater.Step != HierarchyUpdater.UpdateStep.End
                        )
                            m_Updater.Flush();
                ...
                case UpdateModeType.Asynchronous:
                    {
                        ...
                        m_Updater.GameObjectChangeIntegrationBatchSize =
                            m_Configuration.GameObjectChangeIntegrationBatchSize;
                        ...
                        while (
                            m_UpdateTickTimer.ElapsedMilliseconds < m_Configuration.MaximumMillisecondsPerEditorUpdate
                        )
                        {
        ...
        public void GetName(in HierarchyNodeHandle handle, ref FixedString64Bytes name) =>
            m_HierarchyNameStore.GetName(handle, ref name);
            ...
            switch (handle.Kind)
            {
                case NodeKind.Entity:
                {
                    ...
                    return sceneEntity != Entity.Null
                        && SubSceneMap.GetSubSceneStateImmediate(handle, World) == SubSceneLoadedState.Closed;
                }
            ...
            switch (handle.Kind)
            {
                case NodeKind.Entity:
                {
                    ...
                    if (m_World.EntityManager.HasComponent<EntityGuid>(entity))
                    {
                        ...
                        var gameObject =
                            EditorUtility.EntityIdToObject(guid.OriginatingEntityId) as UnityEngine.GameObject;
