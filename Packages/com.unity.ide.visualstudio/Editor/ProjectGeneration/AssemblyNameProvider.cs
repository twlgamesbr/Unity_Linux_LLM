...
namespace Microsoft.Unity.VisualStudio.Editor
{
    ...
    public class AssemblyNameProvider : IAssemblyNameProvider
    {
        ...
        {
            IEnumerable<Assembly> assemblies = GetAssembliesByType(
            ...
            var playerAssemblies = GetAssembliesByType(
                AssembliesType.Player,
                shouldFileBePartOfSolution,
                PlayerAssemblyOutput
            );
            return assemblies.Concat(playerAssemblies);
        }

        private static IEnumerable<Assembly> GetAssembliesByType(
            AssembliesType type,
