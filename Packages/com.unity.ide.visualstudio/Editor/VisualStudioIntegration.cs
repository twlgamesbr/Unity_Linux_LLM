...
#pragma warning restore UAC0006
        ...
        private static void CheckClient(Message message)
        {
            ...
            {
                client = new Client { EndPoint = endPoint, LastMessage = EditorApplication.timeSinceStartup };
        ...
        internal static string PackageVersion()
        {
            var package = UnityEditor.PackageManager.PackageInfo.FindForAssembly(
                typeof(VisualStudioIntegration).Assembly
            );
        ...
        private static void Refresh()
        {
            ...
            var setting = (AssetPipelineAutoRefreshMode)
                EditorPrefs.GetInt("kAutoRefreshMode", Convert.ToInt32(legacySetting));
