...
namespace Microsoft.Unity.VisualStudio.Editor
{
    internal class VisualStudioForWindowsInstallation : VisualStudioInstallation
    {
        ...
        {
            get { return Version >= new Version(16, 3); }
        }

        public override Version LatestLanguageVersionSupported
        {
            get { return GetLatestLanguageVersionSupported(WindowsVersionTable); }
        }
        ...
        public static bool TryDiscoverInstallation(string editorPath, out IVisualStudioInstallation installation)
        {
            ...
            var isPrerelease =
                vi.IsPreRelease || string.Concat(editorPath, "/" + vi.FileDescription).ToLower().Contains("preview");
...
#pragma warning disable CS0649
        ...
        internal class VsWhereResult
        {
            ...
            {
                return JsonUtility.FromJson<VsWhereResult>(
                    "{ \"" + nameof(VsWhereResult.entries) + "\": " + json + " }"
                );
            }
...
#pragma warning restore CS3021
        ...
        private static IEnumerable<VisualStudioInstallation> QueryVsWhere(string progpath, string arguments)
        {
            ...
            return VsWhereResult.FromJson(result.Output).ToVisualStudioInstallations();
        }
...
";
        ...
        {
            var progpath = FileUtility.GetPackageAssetFullPath(
                "Editor",
                "COMIntegration",
                "Release",
                "COMIntegration.exe"
            ...
            var psi = ProcessRunner.ProcessStartInfoFor(
                progpath,
                $"\"{CodeEditor.CurrentEditorInstallation}\" {solution} \"{absolutePath}\" {line}"
            );
                ...
                switch (state)
                {
                    ...
                    case COMIntegrationState.DisplayProgressBar:
                        EditorUtility.DisplayProgressBar(
                            ...
                            "Starting up Visual Studio, this might take some time.",
                            .5f
                        );
        ...
        private static readonly COMIntegrationState[] ProgressBarCommands =
        {
            COMIntegrationState.DisplayProgressBar,
            COMIntegrationState.ClearProgressBar,
        };
