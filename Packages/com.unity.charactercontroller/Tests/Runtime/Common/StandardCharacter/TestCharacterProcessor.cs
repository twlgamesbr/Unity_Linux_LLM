...
namespace Unity.CharacterController.RuntimeTests
{
    ...
    public struct TestCharacterProcessor : IKinematicCharacterProcessor<TestCharacterUpdateContext>
    {
        public KinematicCharacterDataAccess CharacterDataAccess;
        public RefRW<TestCharacterComponent> CharacterComponent;
        public RefRW<TestCharacterControl> CharacterControl;
