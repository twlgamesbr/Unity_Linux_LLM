...
namespace Unity.CharacterController
{
    ...
    {
        /// <summary>
        /// Calculates the signed slope angle in a given movement direction.
        ...
        public static void StandardGroundMove_Accelerated(ref float3 velocity, float3 acceleration, float maxSpeed, float deltaTime, float3 groundingUp, float3 groundedHitNormal, bool forceNoMaxSpeedExcess)
        {
            ...
            velocity = MathUtilities.ReorientVectorOnPlaneAlongDirection(velocity, groundedHitNormal, groundingUp);
            addedVelocityFromAcceleration = MathUtilities.ReorientVectorOnPlaneAlongDirection(addedVelocityFromAcceleration, groundedHitNormal, groundingUp);
