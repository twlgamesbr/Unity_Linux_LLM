...
namespace UnityEditor.Build.Pipeline.Utilities
{
    ...
    /// SpookyHash
    /// </summary>
    public sealed unsafe class SpookyHash : HashAlgorithm
    {
        Hash128 m_Hash;
        ...
        public static new SpookyHash Create()
        {
        ...
        protected override void HashCore(byte[] inputBuffer, int inputOffset, int inputCount)
        {
            ...
            throw new System.InvalidOperationException(
                "SpookyHash implementation was unstable and not deterministic prior to Unity 2020.1. Use MD5 or MD4 instead."
            );
#endif
        }
