...
namespace Unity.Collections
{
    ...
    internal unsafe struct Memory
    {
        ...
        internal struct Unmanaged
        {
            ...
            internal static T* Allocate<T>(AllocatorManager.AllocatorHandle allocator)
                where T : unmanaged
            {
            ...
            [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
            internal static T* Allocate<T>(MemoryLabel label)
                where T : unmanaged
            {
            ...
            [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
            internal static void Free<T>(T* pointer, AllocatorManager.AllocatorHandle allocator)
                where T : unmanaged
            {
                if (pointer == null)
                    return;
            ...
            [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
            internal static void Free<T>(T* pointer, MemoryLabel label)
                where T : unmanaged
            {
                if (pointer == null)
                    return;
            ...
            internal struct Array
            {
                ...
                )
                {
                    ...
                    if (IsCustom(allocator != default ? allocator : label.allocator))
                        return CustomResize(
                            ...
                            oldCount,
                            newCount,
                            allocator != default ? allocator : label.allocator,
                            size,
                            alignment
                        );
                    ...
                    if (newCount > 0)
                    {
                        ...
                        newPointer =
                            allocator != default
                                ? UnsafeUtility.MallocTracked(bytesToAllocate, alignment, allocator.ToAllocator, 0)
                                : UnsafeUtility.MallocTracked(bytesToAllocate, alignment, label, 0);
                ...
                [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
                internal static T* Resize<T>(T* oldPointer, long oldCount, long newCount, MemoryLabel label)
                    where T : unmanaged
                {
                    return (T*)Resize(
                        (byte*)oldPointer,
        ...
        {
            [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
            internal static void Set<T>(T* pointer, long count, T t = default)
                where T : unmanaged
            {
            ...
            [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
            internal static void Clear<T>(T* pointer, long count)
                where T : unmanaged
            {
            ...
            [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
            internal static void Copy<T>(T* dest, T* src, long count)
                where T : unmanaged
            {
