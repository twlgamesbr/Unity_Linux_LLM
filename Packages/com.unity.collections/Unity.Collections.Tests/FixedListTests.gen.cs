...
internal class FixedListTests : CollectionsTestFixture
{
    ...
    public unsafe void FixedList32Byte_GenericAddRangeNoResize()
    {
        ...
        Assert.AreEqual(half, list.Length);
        list.Clear();
        list.AddRangeNoResize(new ReadOnlySpan<byte>(items, half));
        Assert.AreEqual(half, list.Length);
        ...
        Assert.Throws<IndexOutOfRangeException>(() => { list.AddRangeNoResize(new ReadOnlySpan<byte>(items, capacity)); });
#endif
        Assert.AreEqual(half, list.Length); // Verify length didn't change
    }
    ...
    public unsafe void FixedList32Int_GenericAddRangeNoResize()
    {
        ...
        Assert.AreEqual(half, list.Length);
        list.Clear();
        list.AddRangeNoResize(new ReadOnlySpan<int>(items, half));
        Assert.AreEqual(half, list.Length);
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS || UNITY_DOTS_DEBUG
        Assert.Throws<IndexOutOfRangeException>(() => { list.AddRangeNoResize(items, capacity); });
        Assert.Throws<IndexOutOfRangeException>(() => { list.AddRangeNoResize(new ReadOnlySpan<int>(items, capacity)); });
#endif
        Assert.AreEqual(half, list.Length); // Verify length didn't change
    }
    ...
    public unsafe void FixedList32Float_GenericAddRangeNoResize()
    {
        ...
        Assert.AreEqual(half, list.Length);
        list.Clear();
        list.AddRangeNoResize(new ReadOnlySpan<float>(items, half));
        Assert.AreEqual(half, list.Length);
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS || UNITY_DOTS_DEBUG
        Assert.Throws<IndexOutOfRangeException>(() => { list.AddRangeNoResize(items, capacity); });
        Assert.Throws<IndexOutOfRangeException>(() => { list.AddRangeNoResize(new ReadOnlySpan<float>(items, capacity)); });
#endif
        Assert.AreEqual(half, list.Length); // Verify length didn't change
    }
