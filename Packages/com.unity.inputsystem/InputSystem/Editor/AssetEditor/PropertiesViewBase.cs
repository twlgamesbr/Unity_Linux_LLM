...
namespace UnityEngine.InputSystem.Editor
{
    ...
    {
        protected PropertiesViewBase(
            string label,
            SerializedProperty bindingOrAction,
            Action<FourCC> onChange,
        ...
        )
        {
            ...
            m_InteractionsList = new InteractionsListView(
                m_InteractionsProperty,
                OnInteractionsModified,
        ...
        {
            m_ProcessorsList = new ProcessorsListView(
                m_ProcessorsProperty,
        ...
        {
            m_ProcessorsFoldout = DrawFoldout(
                s_ProcessorsFoldoutLabel,
                m_ProcessorsFoldout,
                s_ProcessorsAddButton,
                m_ProcessorsList.OnAddDropdown
            );
        ...
        {
            m_InteractionsFoldout = DrawFoldout(
                s_InteractionsFoldoutLabel,
                m_InteractionsFoldout,
                s_InteractionsAddButton,
                m_InteractionsList.OnAddDropdown
            );
        ...
        private static bool DrawFoldout(
            GUIContent content,
            bool folded,
            GUIContent addButton = null,
            Action<Rect> addDropDown = null
        )
        {
        ...
        public static readonly GUIContent s_ProcessorsAddButton = EditorGUIUtility.TrIconContent(
            "Toolbar Plus More",
            "Add Processor"
        );
        private static readonly GUIContent s_InteractionsFoldoutLabel = EditorGUIUtility.TrTextContent("Interactions");
        public static readonly GUIContent s_InteractionsAddButton = EditorGUIUtility.TrIconContent(
            "Toolbar Plus More",
            "Add Interaction"
        );
