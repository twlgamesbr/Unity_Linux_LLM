...
namespace Unity.Physics
{
    ...
    public struct Constraint : IEquatable<Constraint>
    {
        ...
        /// </summary>
        [Obsolete(
            "DefaultSpringDamping has been deprecated (RemovedAfter 2023-05-09). Use DefaultDampingRatio instead. (UnityUpgradable) -> DefaultDampingRatio",
            false
        )]
        ...
        /// </summary>
        [Obsolete(
            "SpringDamping has been deprecated (RemovedAfter 2023-05-09). Use DampingRatio instead. (UnityUpgradable) -> DampingRatio",
            false
        )]
        [FieldOffset(16)]
        ...
        public int Dimension
        {
            get
            {
                return math.select(
                    math.select(
                        math.select(2, 0, !math.any(ConstrainedAxes)),
                        1,
                        ConstrainedAxes.x ^ ConstrainedAxes.y ^ ConstrainedAxes.z
                    ),
                    3,
        ...
        internal bool ShouldRaiseImpulseEvents =>
            IsNonMotorizedConstraint && math.any(math.abs(MaxImpulse) != DefaultMaxImpulse);

        internal bool IsNonMotorizedConstraint => (Type == ConstraintType.Linear) || (Type == ConstraintType.Angular);
        ...
        public static Constraint BallAndSocket(
            float springFrequency = DefaultSpringFrequency,
        ...
        ///
        /// <returns>   A Constraint. </returns>
        public static Constraint LimitedDistance(
        ...
        ///
        /// <returns>   A Constraint. </returns>
        public static Constraint Cylindrical(
            int freeAxis,
            FloatRange distanceRange,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
        ...
        ///
        /// <returns>   A Constraint. </returns>
        public static Constraint Planar(
            int limitedAxis,
            FloatRange distanceRange,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
        ...
        /// <param name="dampingRatio">     The damping ratio used to relax this constraint. </param>
        /// <returns>A constraint</returns>
        public static Constraint MotorPlanar(
            float target,
            float maxImpulseOfMotor = DefaultMaxImpulse,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
        )
        {
            SafetyChecks.CheckInRangeAndThrow(
                maxImpulseOfMotor,
                new float2(0f, float.PositiveInfinity),
                "maxImpulseOfMotor"
            );
            return new Constraint
            {
        ...
        /// <param name="dampingRatio">     The damping ratio used to relax this constraint. </param>
        /// <returns>A constraint.</returns>
        public static Constraint LinearVelocityMotor(
            float target,
            float maxImpulseOfMotor = DefaultMaxImpulse,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
        ...
        ///
        /// <returns>   A Constraint. </returns>
        public static Constraint Hinge(
            int freeAxis,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
        ...
        ///
        /// <returns>   A Constraint. </returns>
        public static Constraint Twist(
            int limitedAxis,
            FloatRange angularRange,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
        ...
        /// <param name="dampingRatio">     The damping ratio used to relax this constraint. </param>
        /// <returns>A constraint.</returns>
        public static Constraint MotorTwist(
            float target,
            float maxImpulseOfMotor = DefaultMaxImpulse,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
            ...
            MotorTwist(
                target,
                new FloatRange(-math.INFINITY, math.INFINITY),
                maxImpulseOfMotor,
                springFrequency,
                dampingRatio
            );
        ...
        /// <param name="dampingRatio">     The damping ratio used to relax this constraint. </param>
        /// <returns>   A Constraint. </returns>
        public static Constraint AngularVelocityMotor(
            float target,
            float maxImpulseOfMotor = DefaultMaxImpulse,
            float springFrequency = DefaultSpringFrequency,
            float dampingRatio = DefaultDampingRatio
                ...
                return (int)
                    math.hash(
                        new uint4x2(
                            new uint4(
                                (uint)Type,
                                (uint)Min.GetHashCode(),
                                (uint)Max.GetHashCode(),
                                math.hash(ConstrainedAxes)
                            ),
                            new uint4(
                                (uint)SpringFrequency.GetHashCode(),
                                (uint)DampingRatio.GetHashCode(),
                                math.hash(MaxImpulse),
