    ...
    public struct PhysicsWorldData : IDisposable
    {
        ...
        public struct PhysicsWorldComponentHandles
        {
            ...
            public PhysicsWorldComponentHandles(ref SystemState systemState)
            {
                ...
                PhysicsTemporalCoherenceInfoTypeRW = systemState.GetComponentTypeHandle<PhysicsTemporalCoherenceInfo>(
                    false
                );
                PhysicsTemporalCoherenceInfoLookupRW = systemState.GetComponentLookup<PhysicsTemporalCoherenceInfo>(
                    false
                );
        ...
        public PhysicsWorldData(ref SystemState state, in PhysicsWorldIndex worldIndex)
        {
            ...
            using (
                var queryBuilder = new EntityQueryBuilder(Allocator.Temp).WithAll<
                    PhysicsVelocity,
                    LocalTransform,
                    PhysicsWorldIndex
                >()
