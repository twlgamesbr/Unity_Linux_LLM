    ...
    public partial struct SyncCustomPhysicsProxySystem : ISystem
    {
        ...
        partial struct SyncCustomPhysicsProxy : IJobEntity
        {
            ...
            public void Execute(
                ...
                in CustomPhysicsProxyDriver proxyDriver
            )
            {
                var localTransform = localTransformLookup[entity];
                var targetTransform = new RigidTransform(
                    localTransformLookup[proxyDriver.rootEntity].Rotation,
                    localTransformLookup[proxyDriver.rootEntity].Position
                );
