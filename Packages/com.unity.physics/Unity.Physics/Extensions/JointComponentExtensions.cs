...
{
    /// <summary>   Extension methods for working with <see cref="PhysicsJoint"/>. </summary>
    public static class JointComponentExtensions
    {
        ...
        /// </summary>
        ///
        /// <param name="joint">            [in,out] The joint. </param>
        ...
        ///
        /// <returns>
        /// The minimum required and maximum possible distance between the two anchor points along their
        /// aligned axes.
        /// </returns>
        ...
        ///
        /// <param name="joint">            [in,out] The joint. </param>
        /// <param name="distanceOnAxis"> The minimum required and maximum possible distance between the
        /// two anchor points along their aligned axes. </param>
        ...
        ///
        /// <param name="joint">                The joint. </param>
        /// <param name="maxConeAngle">      [out] Half angle of the primary cone, which defines the
        /// maximum possible range of motion in which the primary axis is restricted. </param>
        ...
        /// <summary>
        /// Applies the specified range of motion to a ragdoll primary cone <see cref="PhysicsJoint"/>
        /// created using <see cref="PhysicsJoint.CreateRagdoll"/>.
        /// </summary>
        ///
        /// <param name="joint">                [in,out] The joint. </param>
        ...
        /// <summary>
        /// Gets the range of motion for a ragdoll perpendicular cone <see cref="PhysicsJoint"/> created
        /// using <see cref="PhysicsJoint.CreateRagdoll"/>.
        /// </summary>
        ///
        /// <param name="joint">    The joint. </param>
        ///
        /// <returns>
        /// The range of angular motion defining the cones perpendicular to the primary cone, between
        /// which the primary axis may swing. This range may be asymmetrical.
        /// </returns>
        ...
        ///
        /// <param name="joint">                [in,out] The joint. </param>
        /// <param name="angularPlaneRange"> The range of angular motion defining the cones perpendicular
        /// to the primary cone, between which the primary cone's axis may swing. This range may be
        ...
        ///
        /// <param name="joint">        The joint. </param>
        /// <param name="linearAxes">   [out] The linear axes constrained by the joint. </param>
        /// <param name="angularAxes">  [out] The angular axes constrained by the joint. </param>
