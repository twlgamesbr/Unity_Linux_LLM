...
namespace Unity.Physics
{
    ...
    public struct BoxCollider : IConvexCollider
    {
        ...
        )
        {
            unsafe
            {
                ...
                SafetyChecks.Check16ByteAlignmentAndThrow(
                    boxCollider->m_ConvexHullData.FacePlanes,
        ...
        )
        {
            unsafe
            {
                ...
                fixed (BoxCollider* collider = &this)
                {
                    ...
                    ConvexHull.VertexEdgesBlob.Offset = UnsafeEx.CalculateOffset(
                        ref collider->m_ConvexHullData.VertexEdges[0],
                        ref ConvexHull.VertexEdgesBlob
                    );
                    ConvexHull.VertexEdgesBlob.Length = 8;

                    ConvexHull.FaceLinksBlob.Offset = UnsafeEx.CalculateOffset(
                        ref collider->m_ConvexHullData.FaceLinks[0],
                        ref ConvexHull.FaceLinksBlob
                    );
                    ...
                    faces[2] = new ConvexHull.Face
                    {
                        FirstIndex = 8,
                        NumVertices = 4,
                        MinHalfAngleCompressed = 0x80,
                    };
                    faces[3] = new ConvexHull.Face
                    {
                        FirstIndex = 12,
                        NumVertices = 4,
                        MinHalfAngleCompressed = 0x80,
                    };
                    faces[4] = new ConvexHull.Face
                    {
                        FirstIndex = 16,
                        NumVertices = 4,
                        MinHalfAngleCompressed = 0x80,
                    };
                    faces[5] = new ConvexHull.Face
                    {
                        FirstIndex = 20,
                        NumVertices = 4,
                        MinHalfAngleCompressed = 0x80,
                    ...
                    short* faceVertexIndices = stackalloc short[24]
                    {
                        2,
                        6,
                        4,
                    ...
                    short* vertexEdgeValuePairs = stackalloc short[16]
                    {
                        4,
                        2,
                        2,
        ...
        public void BakeTransform(AffineTransform transform)
        {
            ...
            var bakeToShape = Math.GetBakeToShape(
                transformMatrix,
                new float4x4(rigidTransform),
                ref center,
                ref orientation
            );
        ...
        public Aabb CalculateAabb(RigidTransform transform, float uniformScale = 1.0f)
        {
            ...
            Aabb localAabb = new Aabb { Min = m_Center - halfExtentsInB, Max = m_Center + halfExtentsInB };
