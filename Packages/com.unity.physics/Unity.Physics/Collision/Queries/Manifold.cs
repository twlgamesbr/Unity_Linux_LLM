...
namespace Unity.Physics
{
    ...
    static class ManifoldQueries
    {
        ...
        public static unsafe void BodyBody(
            in RigidBody rigidBodyA,
            in RigidBody rigidBodyB,
            in MotionVelocity motionVelocityA,
            in MotionVelocity motionVelocityB,
            float collisionTolerance,
            float timeStep,
            BodyIndexPair pair,
            ref NativeStream.Writer contactWriter
        )
        {
            ...
            if (
                colliderA == null
                || colliderB == null
                || !CollisionFilter.IsCollisionEnabled(colliderA->GetCollisionFilter(), colliderB->GetCollisionFilter())
            )
            {
                return;
            }
            ...
            var context = new Context
            {
                ...
                {
                    CustomTagsA = rigidBodyA.CustomTags,
                    CustomTagsB = rigidBodyB.CustomTags,
                },
                ...
                case CollisionType.Convex:
                    switch (colliderB->CollisionType)
                    {
                        case CollisionType.Convex:
                            ConvexConvex(
                                context,
                                ColliderKeyPair.Empty,
                                colliderA,
                                colliderB,
                                worldFromA,
                                worldFromB,
                                expansion.MaxDistance,
                                false
                            );
                            break;
        ...
        private static unsafe void WriteManifold(
            ConvexConvexManifoldQueries.Manifold manifold,
            Context context,
        ...
        )
        {
            ...
            if (manifold.NumContacts > 0)
            {
                ...
                // Apply materials
                {
                    ...
                    CollisionResponsePolicy combinedCollisionResponse = Material.GetCombinedCollisionResponse(
                        materialA,
                        materialB
                    );
                    Unity.Assertions.Assert.IsFalse(
                        combinedCollisionResponse == CollisionResponsePolicy.None,
                ...
                int startIndex = 0;
                int increment =
                    header.NumContacts < 6
                        ? math.max(header.NumContacts / 2, 1)
                        : (header.NumContacts / 3 + ((header.NumContacts % 3 > 0) ? 1 : 0));
        ...
        private static unsafe void ConvexConvex(
            Context context,
            ColliderKeyPair colliderKeys,
            Collider* convexColliderA,
            Collider* convexColliderB,
        ...
        )
        {
            ...
            {
                if (
                    combinedCollisionResponse != CollisionResponsePolicy.RaiseTriggerEvents
            ...
            switch (typeA)
            {
                    ...
                    switch (typeB)
                    {
                        case ColliderType.Sphere:
                            ConvexConvexManifoldQueries.SphereSphere(
                                (SphereCollider*)convexColliderA,
                                (SphereCollider*)convexColliderB,
                                worldFromA,
                                aFromB,
                                maxDistance,
                                out contactManifold
                        ...
                        case ColliderType.Capsule:
                            ConvexConvexManifoldQueries.CapsuleSphere(
                                (CapsuleCollider*)convexColliderB,
                                (SphereCollider*)convexColliderA,
                                worldFromB,
                                Inverse(aFromB),
                                maxDistance,
                        ...
                        case ColliderType.Triangle:
                            ConvexConvexManifoldQueries.TriangleSphere(
                                (PolygonCollider*)convexColliderB,
                                (SphereCollider*)convexColliderA,
                                worldFromB,
                                Inverse(aFromB),
                                maxDistance,
                        ...
                        case ColliderType.Convex:
                            ConvexConvexManifoldQueries.ConvexConvex(
                                ref ((SphereCollider*)convexColliderA)->ConvexHull,
                                ref ((ConvexCollider*)convexColliderB)->ConvexHull,
                                worldFromA,
                                aFromB,
                                maxDistance,
                                out contactManifold
                ...
                case ColliderType.Box:
                    switch (typeB)
                    {
                        ...
                        case ColliderType.Convex:
                            ConvexConvexManifoldQueries.ConvexConvex(
                                ref ((BoxCollider*)convexColliderA)->ConvexHull,
                                ref ((ConvexCollider*)convexColliderB)->ConvexHull,
                                worldFromA,
                                aFromB,
                                maxDistance,
                ...
                case ColliderType.Capsule:
                    switch (typeB)
                    {
                        case ColliderType.Sphere:
                            ConvexConvexManifoldQueries.CapsuleSphere(
                                (CapsuleCollider*)convexColliderA,
                                (SphereCollider*)convexColliderB,
                                worldFromA,
                                aFromB,
                                maxDistance,
                        ...
                        case ColliderType.Convex:
                            ConvexConvexManifoldQueries.ConvexConvex(
                                ref ((CapsuleCollider*)convexColliderA)->ConvexHull,
                                ref ((ConvexCollider*)convexColliderB)->ConvexHull,
                                worldFromA,
                                aFromB,
                                maxDistance,
                ...
                case ColliderType.Triangle:
                    switch (typeB)
                    {
                        case ColliderType.Sphere:
                            ConvexConvexManifoldQueries.TriangleSphere(
                                (PolygonCollider*)convexColliderA,
                                (SphereCollider*)convexColliderB,
                                worldFromA,
                                aFromB,
                                maxDistance,
                        ...
                        case ColliderType.Convex:
                            ConvexConvexManifoldQueries.ConvexConvex(
                                ref ((PolygonCollider*)convexColliderA)->ConvexHull,
                                ref ((ConvexCollider*)convexColliderB)->ConvexHull,
                                worldFromA,
                                aFromB,
                                maxDistance,
                ...
                case ColliderType.Convex:
                    ...
                    if (!IsApproximatelyEqual(context.ScaleA, 1.0f))
                    {
                        ...
                        convexHullA.CalculateScalingData(
                            scaledVertexPtrA,
                            scaledPlanePtrA,
                            context.ScaleA,
                            out convexRadiusA
                    ...
                    if (!IsApproximatelyEqual(context.ScaleB, 1.0f))
                    {
                        ...
                        convexHullB.CalculateScalingData(
                            scaledVertexPtrB,
                            scaledPlanePtrB,
                            context.ScaleB,
                            out convexRadiusB
                    ...
                    ConvexConvexManifoldQueries.ConvexConvex(
                        ...
                        convexRadiusA,
                        convexRadiusB,
                        ref ((ConvexCollider*)convexColliderA)->ConvexHull,
                        ref ((ConvexCollider*)convexColliderB)->ConvexHull,
                        worldFromA,
                        aFromB,
                        maxDistance,
        ...
        private static unsafe void ConvexComposite(
            Context context,
            ColliderKey convexKeyA,
            [NoAlias] Collider* convexColliderA,
            [NoAlias] Collider* compositeColliderB,
            [NoAlias] in MTransform worldFromA,
            [NoAlias] in MTransform worldFromB,
            MotionExpansion expansionWS,
            bool flipped
        )
        {
            Material materialA = ((ConvexColliderHeader*)convexColliderA)->Material;
        ...
        private static unsafe void CompositeConvex(
            Context context,
            [NoAlias] Collider* compositeColliderA,
            [NoAlias] Collider* convexColliderB,
            [NoAlias] in MTransform worldFromA,
            [NoAlias] in MTransform worldFromB,
            MotionExpansion expansion,
            bool flipped
        ...
        internal unsafe struct ConvexCompositeOverlapCollector : IOverlapCollector
        {
            ...
            public void AddColliderKeys([NoAlias] ColliderKey* keys, int count)
            {
                var colliderKeys = new ColliderKeyPair
                {
                    ...
                    ColliderKeyB = m_ConvexColliderKey,
                };
                    ...
                    default:
                        {
                            for (int i = 0; i < count; i++)
                            {
                                ...
                                if (CollisionFilter.IsCollisionEnabled(filter, leaf.Collider->GetCollisionFilter())) // TODO: shouldn't be needed if/when filtering is done fully by the BVH query
                                {
                                    ...
                                    ScaledMTransform worldFromLeafB = ScaledMTransform.Mul(
                                        new ScaledMTransform(m_WorldFromB, m_Context.ScaleB),
                                        new MTransform(leaf.TransformFromChild)
                                    );
        ...
        private static unsafe void CompositeComposite(
            Context context,
            Collider* compositeColliderA,
            Collider* compositeColliderB,
            MTransform worldFromA,
            MTransform worldFromB,
            MotionExpansion expansion,
            bool flipped
        ...
        private unsafe struct CompositeCompositeLeafCollector : ILeafColliderCollector
        {
            ...
            {
                ScaledMTransform worldFromLeafA = ScaledMTransform.Mul(
                    new ScaledMTransform(m_WorldFromA, m_Context.ScaleA),
                    new MTransform(leaf.TransformFromChild)
                );

                ConvexComposite(
                    m_Context,
                    m_KeyPath.GetLeafKey(key),
                    leaf.Collider,
                    m_CompositeColliderB,
                    worldFromLeafA.Transform,
                    m_WorldFromB,
                    m_Expansion,
                    m_Flipped
                );
            ...
            public void PushCompositeCollider(
                ColliderKeyPath compositeKey,
                MTransform parentFromComposite,
                out MTransform worldFromParent
            )
            {
                m_KeyPath.PushChildKey(compositeKey);
                worldFromParent = m_WorldFromA;

                ScaledMTransform worldFromA = ScaledMTransform.Mul(
                    new ScaledMTransform(worldFromParent, m_Context.ScaleA),
                    parentFromComposite
                );
        ...
        private static unsafe void ConvexTerrain(
            ...
            ColliderKeyPair colliderKeys,
            [NoAlias] Collider* convexColliderA,
            [NoAlias] Collider* terrainColliderB,
            [NoAlias] in MTransform worldFromA,
            [NoAlias] in MTransform worldFromB,
            float maxDistance,
            bool flipped
        )
        {
            ...
            for (int iVertex = 0; iVertex < numVertices; iVertex++)
            {
                ...
                if (
                    terrain.GetHeightAndGradient(
                        pointAInB.xz * invTerrainUniformScale,
                        out float height,
                        out float2 gradient
                    )
                )
                {
                    ...
                    if (distance < maxDistance + convexRadius)
                    {
                        ...
                        if (
                            math.dot(normalInB, normal) < 1 - 1e-5f
                            || manifold.NumContacts == ConvexConvexManifoldQueries.Manifold.k_MaxNumContacts
                        )
                        {
