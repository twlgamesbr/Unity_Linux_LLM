...
namespace Unity.Physics
{
    public static partial class Math
    {
        ...
        internal struct FourTransposedPoints
        {
            ...
            public FourTransposedPoints V0000 =>
                new FourTransposedPoints { m_TransposedPoints = new float4x3(X.xxxx, Y.xxxx, Z.xxxx) };
            public FourTransposedPoints V1111 =>
                new FourTransposedPoints { m_TransposedPoints = new float4x3(X.yyyy, Y.yyyy, Z.yyyy) };
            public FourTransposedPoints V2222 =>
                new FourTransposedPoints { m_TransposedPoints = new float4x3(X.zzzz, Y.zzzz, Z.zzzz) };
            public FourTransposedPoints V3333 =>
                new FourTransposedPoints { m_TransposedPoints = new float4x3(X.wwww, Y.wwww, Z.wwww) };
            public FourTransposedPoints V1230 =>
                new FourTransposedPoints { m_TransposedPoints = new float4x3(X.yzwx, Y.yzwx, Z.yzwx) };
            public FourTransposedPoints V3012 =>
                new FourTransposedPoints { m_TransposedPoints = new float4x3(X.wxyz, Y.wxyz, Z.wxyz) };
            public FourTransposedPoints V1203 =>
                new FourTransposedPoints { m_TransposedPoints = new float4x3(X.yzxw, Y.yzxw, Z.yzxw) };
            ...
            public static FourTransposedPoints operator +(FourTransposedPoints lhs, FourTransposedPoints rhs)
            {
                ...
                {
                    m_TransposedPoints = lhs.m_TransposedPoints + rhs.m_TransposedPoints,
                };
            }
