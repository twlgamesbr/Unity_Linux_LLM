...
namespace Unity.Jobs
{
    ...
    {
        public static JobHandle ScheduleUnsafeIndex0<T>(
            this T jobData,
            ...
            where T : struct, IJobParallelForDefer
        {
            unsafe
            {
                return IJobParallelForDeferExtensions.Schedule(
                    jobData,
        ...
        /// </summary>
        public static JobHandle ScheduleUnsafe<T>(
            this T jobData,
            ...
            where T : struct, IJobParallelForDefer
        {
            unsafe
            {
                return IJobParallelForDeferExtensions.Schedule(
                    jobData,
                    NativeReferenceUnsafeUtility.GetUnsafePtrWithoutChecks(forEachCount),
                    innerloopBatchCount,
                    dependsOn
                );
            }
            ...
            where T : struct, IJobParallelForDefer
        {
            unsafe
            {
                return IJobParallelForDeferExtensions.Schedule(
                    jobData,
                    (int*)stream.GetUnsafeForEachCountPtr(),
                    innerloopBatchCount,
                    dependsOn
                );
            }
