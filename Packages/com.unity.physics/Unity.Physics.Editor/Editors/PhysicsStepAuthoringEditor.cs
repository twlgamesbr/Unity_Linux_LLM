...
namespace Unity.Physics.Editor
{
    ...
    class PhysicsStepAuthoringEditor : BaseEditor
    {
        ...
        {
            public static readonly GUIContent SolverStabilizationLabelUnityPhysics = EditorGUIUtility.TrTextContent(
...
#pragma warning disable 649
        [AutoPopulate]
        SerializedProperty m_SimulationType;

        [AutoPopulate]
        SerializedProperty m_Gravity;

        [AutoPopulate]
        SerializedProperty m_EnableGyroscopicTorque;

        [AutoPopulate]
        SerializedProperty m_SubstepCount;

        [AutoPopulate]
        SerializedProperty m_SolverIterationCount;

        [AutoPopulate]
        SerializedProperty m_DirectSolverSettings;

        [AutoPopulate]
        SerializedProperty m_EnableSolverStabilizationHeuristic;

        [AutoPopulate]
        SerializedProperty m_MultiThreaded;

        [AutoPopulate]
        SerializedProperty m_CollisionTolerance;

        [AutoPopulate]
        SerializedProperty m_SynchronizeCollisionWorld;

        [AutoPopulate]
        SerializedProperty m_IncrementalDynamicBroadphase;

        [AutoPopulate]
        SerializedProperty m_IncrementalStaticBroadphase;

        [AutoPopulate]
        SerializedProperty m_MaxDynamicDepenetrationVelocity;

        [AutoPopulate]
        SerializedProperty m_MaxStaticDepenetrationVelocity;
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(m_SimulationType.intValue == (int)SimulationType.NoPhysics))
            {
                ...
                EditorGUILayout.PropertyField(
                    m_EnableSolverStabilizationHeuristic,
                    Content.SolverStabilizationLabelUnityPhysics
                );
            }
