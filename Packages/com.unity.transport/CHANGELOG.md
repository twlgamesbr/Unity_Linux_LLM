...
### Changes
* Starting with this release, Unity Transport is now a built-in package and is shipped alongside the editor. All further changes within the Unity 6.5 release stream will be noted in the engine release notes instead of here.
* All APIs that were marked as obsolete in previous releases are now completely removed from the package.
