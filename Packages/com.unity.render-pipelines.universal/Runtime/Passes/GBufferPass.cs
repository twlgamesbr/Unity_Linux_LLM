...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class GBufferPass : ScriptableRenderPass
    {
        ...
        )
        {
            ...
            {
                DeferredLights.OverwriteStencil(
                    m_RenderStateBlock,
                    (int)StencilUsage.MaterialMask,
                    (int)StencilUsage.MaterialLit
                ),
                DeferredLights.OverwriteStencil(
                    m_RenderStateBlock,
                    (int)StencilUsage.MaterialMask,
                    (int)StencilUsage.MaterialSimpleLit
                ),
                DeferredLights.OverwriteStencil(
                    m_RenderStateBlock,
                    (int)StencilUsage.MaterialMask,
                ...
                DeferredLights.OverwriteStencil(
                    ...
                    (int)StencilUsage.MaterialMask,
                    (int)StencilUsage.MaterialUnlit
                ), // Fill GBuffer, but skip lighting pass for ComplexLit
                DeferredLights.OverwriteStencil(
                    m_RenderStateBlock,
                    (int)StencilUsage.MaterialMask,
                    (int)StencilUsage.MaterialUnlit
                ), // Fill GBuffer, but skip lighting pass for BakedLit
                DeferredLights.OverwriteStencil(
                    m_RenderStateBlock,
                    (int)StencilUsage.MaterialMask,
                    (int)StencilUsage.MaterialLit
        ...
        static void ExecutePass(
            ...
            RendererList errorRendererList
        )
        {
            bool usesRenderingLayers =
                data.deferredLights.UseRenderingLayers && !data.deferredLights.HasRenderingLayerPrepass;
        ...
        )
        {
            ...
            bool useCameraRenderingLayersTexture =
                m_DeferredLights.UseRenderingLayers && !m_DeferredLights.UseLightLayers;
            ...
            if (setGlobalTextures)
            {
                ...
                if (useCameraRenderingLayersTexture)
                    builder.SetGlobalTextureAfterPass(
                        ...
                        s_CameraRenderingLayersTextureID
                    );
            }
