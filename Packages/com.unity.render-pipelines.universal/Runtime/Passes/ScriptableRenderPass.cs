...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderPass : IRenderGraphRecorder
    {
        ...
        )
        {
            ...
            return RenderingUtils.CreateDrawingSettings(
                shaderTagId,
        ...
        internal static int GetRenderPassEventRange(RenderPassEvent renderPassEvent)
        {
            ...
            {
                Debug.LogError(
                    "GetRenderPassEventRange: invalid renderPassEvent value cannot be found in the RenderPassEvent enumeration"
                );
                return 0;
            }
