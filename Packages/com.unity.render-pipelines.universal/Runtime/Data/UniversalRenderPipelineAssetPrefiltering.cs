...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset
    {
        ...
        [ShaderKeywordFilter.RemoveIf(
            PrefilteringModeMainLightShadows.Remove,
            keywordNames: new[] { ShaderKeywordStrings.MainLightShadows, ShaderKeywordStrings.MainLightShadowCascades }
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeMainLightShadows.SelectMainLight,
            keywordNames: ShaderKeywordStrings.MainLightShadows
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeMainLightShadows.SelectMainLightAndOff,
            keywordNames: new[] { "", ShaderKeywordStrings.MainLightShadows }
        )]
        [ShaderKeywordFilter.SelectIf(
        ...
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeMainLightShadows.SelectAll,
            keywordNames: new[]
            {
                "",
                ShaderKeywordStrings.MainLightShadows,
                ShaderKeywordStrings.MainLightShadowCascades,
            }
        )]
        [SerializeField]
        private PrefilteringModeMainLightShadows m_PrefilteringModeMainLightShadows =
            PrefilteringModeMainLightShadows.SelectMainLight;
        ...
        [ShaderKeywordFilter.RemoveIf(
            PrefilteringModeAdditionalLights.Remove,
            keywordNames: new string[]
            {
        ...
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeAdditionalLights.SelectVertex,
            keywordNames: ShaderKeywordStrings.AdditionalLightsVertex
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeAdditionalLights.SelectVertexAndOff,
            keywordNames: new string[] { "", ShaderKeywordStrings.AdditionalLightsVertex }
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeAdditionalLights.SelectPixel,
            keywordNames: ShaderKeywordStrings.AdditionalLightsPixel
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeAdditionalLights.SelectPixelAndOff,
            keywordNames: new string[] { "", ShaderKeywordStrings.AdditionalLightsPixel }
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringModeAdditionalLights.SelectAll,
            keywordNames: new string[]
            {
                "",
                ShaderKeywordStrings.AdditionalLightsVertex,
        ...
        [SerializeField]
        private PrefilteringModeAdditionalLights m_PrefilteringModeAdditionalLight =
            PrefilteringModeAdditionalLights.SelectPixelAndOff;

        // Additional Lights Shadows
        [ShaderKeywordFilter.RemoveIf(
            PrefilteringMode.Remove,
            keywordNames: ShaderKeywordStrings.AdditionalLightShadows
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringMode.Select,
            keywordNames: new string[] { "", ShaderKeywordStrings.AdditionalLightShadows }
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringMode.SelectOnly,
            keywordNames: ShaderKeywordStrings.AdditionalLightShadows
        )]
        [SerializeField]
        private PrefilteringMode m_PrefilteringModeAdditionalLightShadows = PrefilteringMode.Select;

        // XR Specific keywords
        [ShaderKeywordFilter.RemoveIf(
            true,
            keywordNames: new[] { ShaderKeywordStrings.BlitSingleSlice, ShaderKeywordStrings.XROcclusionMeshCombined }
        )]
        [SerializeField]
        private bool m_PrefilterXRKeywords = false;

        // Forward+ / Deferred+
        [ShaderKeywordFilter.RemoveIf(PrefilteringMode.Remove, keywordNames: ShaderKeywordStrings.ClusterLightLoop)]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringMode.Select,
            keywordNames: new[] { "", ShaderKeywordStrings.ClusterLightLoop }
        )]
        [ShaderKeywordFilter.SelectIf(PrefilteringMode.SelectOnly, keywordNames: ShaderKeywordStrings.ClusterLightLoop)]
        [SerializeField]
        private PrefilteringMode m_PrefilteringModeForwardPlus = PrefilteringMode.Select;
        ...
        [SerializeField]
        private PrefilteringMode m_PrefilteringModeDeferredRendering = PrefilteringMode.Select;

        // Screen Space Occlusion
        [ShaderKeywordFilter.RemoveIf(PrefilteringMode.Remove, keywordNames: ShaderKeywordStrings.ScreenSpaceOcclusion)]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringMode.Select,
            keywordNames: new[] { "", ShaderKeywordStrings.ScreenSpaceOcclusion }
        )]
        [ShaderKeywordFilter.SelectIf(
            PrefilteringMode.SelectOnly,
            keywordNames: ShaderKeywordStrings.ScreenSpaceOcclusion
        )]
        [SerializeField]
        private PrefilteringMode m_PrefilteringModeScreenSpaceOcclusion = PrefilteringMode.Select;

        // Rendering Debugger
        [ShaderKeywordFilter.RemoveIf(true, keywordNames: ShaderKeywordStrings.DEBUG_DISPLAY)]
        [SerializeField]
        private bool m_PrefilterDebugKeywords = false;
        ...
        [ShaderKeywordFilter.RemoveIf(true, keywordNames: ShaderKeywordStrings.WriteRenderingLayers)]
        [SerializeField]
        private bool m_PrefilterWriteRenderingLayers = false;
        ...
        [ShaderKeywordFilter.RemoveIf(
            ...
            keywordNames: new[]
            {
                HDRKeywords.HDR_INPUT,
                HDRKeywords.HDR_COLORSPACE_CONVERSION,
                HDRKeywords.HDR_ENCODING,
                HDRKeywords.HDR_COLORSPACE_CONVERSION_AND_ENCODING,
            }
        )]
        [SerializeField]
        private bool m_PrefilterHDROutput = false;

        // Alpha Output
        [ShaderKeywordFilter.RemoveIf(true, keywordNames: ShaderKeywordStrings._ENABLE_ALPHA_OUTPUT)]
        [SerializeField]
        private bool m_PrefilterAlphaOutput = false;
        ...
        [SerializeField]
        private bool m_PrefilterUseLegacyLightmaps = false;
        ...
        [SerializeField]
        private bool m_PrefilterBicubicLightmapSampling = false;
        ...
        [SerializeField]
        private bool m_PrefilterReflectionProbeRotation = false;
        ...
        [SerializeField]
        private bool m_PrefilterReflectionProbeBlending = false;
        ...
        [SerializeField]
        private bool m_PrefilterReflectionProbeBoxProjection = false;
        ...
        [SerializeField]
        private bool m_PrefilterReflectionProbeAtlas = false;
        ...
        [SerializeField]
        private bool m_PrefilterPointSamplingUpsampling = false;
