...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class DebugDisplaySettingsLighting : IDebugDisplaySettingsData, ISerializedDebugDisplaySettings
    {
        ...
        {
            public static readonly NameAndTooltip LightingDebugMode = new()
            {
                name = "Lighting Debug Mode",
                tooltip =
                    "Use the drop-down to select which lighting and shadow debug information to overlay on the screen.",
            };
            public static readonly NameAndTooltip LightingFeatures = new()
            {
                name = "Lighting Features",
                tooltip = "Filter and debug selected lighting features in the system.",
            };
            public static readonly NameAndTooltip HDRDebugMode = new()
            {
                name = "HDR Debug Mode",
        ...
        internal static class WidgetFactory
        {
            ...
            internal static DebugUI.Widget CreateHDRDebugMode(DebugDisplaySettingsLighting data) =>
                new DebugUI.EnumField
                {
                ...
                : base(data)
            {
                ...
                AddWidget(
                    new DebugUI.Foldout
                    {
                        ...
                        documentationUrl = typeof(DebugDisplaySettingsLighting)
                            .GetCustomAttribute<HelpURLAttribute>()
                            ?.URL,
                    }
                );
            }
        ...
        public bool AreAnySettingsActive =>
            (lightingDebugMode != DebugLightingMode.None)
        ...
        public bool IsPostProcessingAllowed =>
            (
                lightingDebugMode != DebugLightingMode.Reflections
                && lightingDebugMode != DebugLightingMode.ReflectionsWithSmoothness
            );
