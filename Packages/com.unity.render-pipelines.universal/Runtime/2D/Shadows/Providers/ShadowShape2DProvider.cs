...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract class ShadowShape2DProvider : Provider2D
    {
        ...
        public virtual GUIContent ProviderName(string componentName)
        {
            return new GUIContent(componentName, "Implemented by " + this.GetType().Name);
        }
        ...
        internal override bool Internal_IsRequiredComponentData(Component sourceComponent)
        {
            return IsRequiredComponentData(sourceComponent);
        }
    }
}
