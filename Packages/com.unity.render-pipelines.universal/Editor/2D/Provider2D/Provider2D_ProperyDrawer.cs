...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class Provider2D_ProperyDrawer : PropertyDrawer
    {
        ...
        bool IsChildVisible(Type parentType, SerializedProperty child)
        {
            ...
            bool publicAndVisible =
                fieldInfoPublic != null
                && (
                    (fieldInfoPublic.GetCustomAttribute<HideInInspector>() == null)
                    || (fieldInfoPublic.GetCustomAttribute<NonSerializedAttribute>() == null)
                );
            ...
            if (fieldInfoPublic == null)
            {
                ...
                FieldInfo fieldInfoNonPublic = parentType.GetField(
                    child.name,
                    BindingFlags.NonPublic | BindingFlags.Instance
                );
                privateButVisible =
                    fieldInfoNonPublic != null && (fieldInfoNonPublic.GetCustomAttribute<SerializeField>() != null);
            }
