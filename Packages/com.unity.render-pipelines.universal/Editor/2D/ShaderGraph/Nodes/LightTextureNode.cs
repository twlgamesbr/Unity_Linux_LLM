...
namespace UnityEngine.Experimental.Rendering.Universal
{
    ...
    [SubTargetFilterAttribute(
        new[] { typeof(UniversalSpriteCustomLitSubTarget), typeof(UniversalSpriteUnlitSubTarget) }
    )]
    class LightTextureNode : AbstractMaterialNode, IGeneratesFunction
    {
        ...
        [SerializeField]
        private BlendStyle m_BlendStyle = BlendStyle.LightTex0;
        ...
        {
            registry.RequiresIncludePath(
                "Packages/com.unity.render-pipelines.universal/Shaders/2D/Include/ShapeLightShared.hlsl",
                true
            );
            registry.RequiresIncludePath(
                "Packages/com.unity.render-pipelines.universal/Shaders/2D/Include/ShapeLightVariables.hlsl"
            );

            registry.ProvideFunction(
                $"Unity_GetLightTexture{(int)m_BlendStyle}",
                s =>
                {
