...
namespace UnityEditor.Rendering.Universal
{
    static partial class EditorUtils
    {
        ...
        internal class Styles
        {
            ...
            public static readonly GUIContent alembicMotionVectors = EditorGUIUtility.TrTextContent(
            ...
            public static readonly GUIContent xrMotionVectorsPass = EditorGUIUtility.TrTextContent(
                "XR Motion Vectors Pass (Space Warp)",
        ...
        internal static void QualitySettingsHelpBox(
            string message,
            MessageType type,
            UniversalRenderPipelineAssetUI.Expandable expandable,
            string propertyPath
        )
        {
            CoreEditorUtils.DrawFixMeBox(
