...
namespace UnityEditor
{
    ...
    class SixWayGUI : ShaderGraphLitGUI
    {
        ...
        protected class SixWayStyles
        {
            ...
            /// </summary>
            public static readonly GUIContent UseColorAbsorptionText = EditorGUIUtility.TrTextContent(
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            useColorAbsorption = FindProperty(
                UniversalSixWaySubTarget.SixWayProperties.UseColorAbsorption,
                properties,
                false
            );
        }
        ...
        public static void UpdateSixWayKeywords(Material material)
        {
            ...
            if (material.HasProperty(UniversalSixWaySubTarget.SixWayProperties.UseColorAbsorption))
                useColorAbsorptionValue =
                    material.GetFloat(UniversalSixWaySubTarget.SixWayProperties.UseColorAbsorption) > 0.0f;
