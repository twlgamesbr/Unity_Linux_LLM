...
namespace UnityEditor.Rendering.Universal
{
    ...
    class StandardSimpleLightingUpgraderProvider : IMaterialUpgradersProvider
    {
        public IEnumerable<MaterialUpgrader> GetUpgraders()
        {
            yield return new StandardSimpleLightingUpgrader(
                "Legacy Shaders/Diffuse",
                SupportedUpgradeParams.diffuseOpaque
            );
            yield return new StandardSimpleLightingUpgrader(
            ...
            yield return new StandardSimpleLightingUpgrader(
                ...
                SupportedUpgradeParams.specularOpaque
            );
            yield return new StandardSimpleLightingUpgrader(
            ...
            yield return new StandardSimpleLightingUpgrader(
                ...
                SupportedUpgradeParams.specularAlphaCutout
            );

            // Reflective
            yield return new StandardSimpleLightingUpgrader(
                "Legacy Shaders/Reflective/Bumped Diffuse",
                SupportedUpgradeParams.diffuseCubemap
            );
            yield return new StandardSimpleLightingUpgrader(
                "Legacy Shaders/Reflective/Bumped Specular",
                SupportedUpgradeParams.specularCubemap
            );
            yield return new StandardSimpleLightingUpgrader(
            ...
            yield return new StandardSimpleLightingUpgrader(
                ...
                SupportedUpgradeParams.diffuseAlpha
            );
            yield return new StandardSimpleLightingUpgrader(
                "Legacy Shaders/Transparent/Specular",
                SupportedUpgradeParams.specularAlpha
            );
            yield return new StandardSimpleLightingUpgrader(
            ...
            yield return new StandardSimpleLightingUpgrader(
                ...
                SupportedUpgradeParams.diffuseAlphaCutout
            );
            yield return new StandardSimpleLightingUpgrader(
