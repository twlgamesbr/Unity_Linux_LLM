...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class BuiltInToURP3DReadonlyMaterialConverter : ReadonlyMaterialConverter
    {
        ...
        public override string isDisabledMessage =>
            "Converter requires URP with an Universal Renderer. Convert your project to URP to use this converter.";
        ...
        protected override Dictionary<string, Func<Material>> materialMappings
        {
            get
            {
                return new()
                {
                    ["Default-Diffuse"] = () =>
                        GraphicsSettings
                            .GetRenderPipelineSettings<UniversalRenderPipelineEditorMaterials>()
                            .defaultMaterial,
                    ["Default-Material"] = () =>
                        GraphicsSettings
                            .GetRenderPipelineSettings<UniversalRenderPipelineEditorMaterials>()
                    ...
                    ["Default-ParticleSystem"] = () =>
                        GraphicsSettings
                            .GetRenderPipelineSettings<UniversalRenderPipelineEditorMaterials>()
                            .defaultParticleUnlitMaterial,
                    ["Default-Particle"] = () =>
                        GraphicsSettings
                            .GetRenderPipelineSettings<UniversalRenderPipelineEditorMaterials>()
                            .defaultParticleUnlitMaterial,
                    ["Default-Terrain-Diffuse"] = () =>
                        GraphicsSettings
                            .GetRenderPipelineSettings<UniversalRenderPipelineEditorMaterials>()
                            .defaultTerrainLitMaterial,
                    ["Default-Terrain-Specular"] = () =>
                        GraphicsSettings
                            .GetRenderPipelineSettings<UniversalRenderPipelineEditorMaterials>()
                            .defaultTerrainLitMaterial,
                    ["Default-Terrain-Standard"] = () =>
                        GraphicsSettings
                            .GetRenderPipelineSettings<UniversalRenderPipelineEditorMaterials>()
                            .defaultTerrainLitMaterial,
                    ["Sprites-Default"] = () =>
                    ...
                    ["SpatialMappingOcclusion"] = () =>
                        AssetDatabase.LoadAssetAtPath<Material>(
                            "Packages/com.unity.render-pipelines.universal/Runtime/Materials/SpatialMappingOcclusion.mat"
                        ),
                    ["SpatialMappingWireframe"] = () =>
                        AssetDatabase.LoadAssetAtPath<Material>(
                            "Packages/com.unity.render-pipelines.universal/Runtime/Materials/SpatialMappingWireframe.mat"
                        ),
                };
            }
        }
