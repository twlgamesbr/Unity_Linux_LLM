...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class ShaderScriptableStripper : IShaderVariantStripper, IShaderVariantStripperScope
    {
        ...
        internal struct StrippingData : IShaderScriptableStrippingData
        {
            ...
            {
                get => passData.shaderType;
                set { }
            }
            public ShaderCompilerPlatform shaderCompilerPlatform
            {
                get => variantData.shaderCompilerPlatform;
                set { }
            }

            public string passName
            {
                get => passData.passName;
                set { }
            }
            public PassType passType
            {
                get => passData.passType;
                set { }
            }
            ...
            public bool IsHDRDisplaySupportEnabled { get; set; }
            public bool IsHDRShaderVariantValid
            {
                get =>
                    HDROutputUtils.IsShaderVariantValid(
                        variantData.shaderKeywordSet,
        ...
        private void InitializeLocalShaderKeywords([DisallowNull] Shader shader)
        {
            ...
            m_ReflectionProbeBoxProjection = TryGetLocalKeyword(
                shader,
            ...
            m_UseFastSRGBLinearConversion = TryGetLocalKeyword(
                shader,
            ...
            m_FoveatedRenderingNonUniformRaster = TryGetLocalKeyword(
                shader,
        ...
        *********************************************************/
        ...
        internal bool StripVolumeFeatures_UberPostShader(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            ShaderStripTool<VolumeFeatures> stripTool = new ShaderStripTool<VolumeFeatures>(
        ...
        internal bool StripVolumeFeatures_BloomShader(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            bool isBloomEnabled =
                strippingData.IsVolumeFeatureEnabled(VolumeFeatures.BloomHQ)
        ...
        *********************************************************/
        ...
        {
            return strippingData.stripScreenCoordOverrideVariants
                && strippingData.IsKeywordEnabled(m_ScreenCoordOverride);
        }
        ...
        internal bool StripUnusedFeatures_PunctualLightShadows(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (
                strippingData.passType == PassType.ShadowCaster
                && strippingData.PassHasKeyword(m_CastingPunctualLightShadow)
            )
            {
                ...
                if (
                    ...
                    && strippingData.IsKeywordEnabled(m_CastingPunctualLightShadow)
                )
                    return true;
            }
        ...
        internal bool StripUnusedFeatures_FoveatedRendering(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (
                strippingData.shaderCompilerPlatform != ShaderCompilerPlatform.PS5NGGC
        ...
        {
            bool hasDeferredRendererType =
                strippingData.IsShaderFeatureEnabled(ShaderFeatures.DeferredShading)
        ...
        internal bool StripUnusedFeatures_MainLightShadows(
            ref IShaderScriptableStrippingData strippingData,
        ...
        )
        {
            ...
            {
                if (
                    stripTool.StripMultiCompileKeepOffVariant(
                        m_MainLightShadows,
                        ShaderFeatures.MainLightShadows,
                        m_MainLightShadowsCascades,
                        ShaderFeatures.MainLightShadowsCascade,
                        m_MainLightShadowsScreen,
                        ShaderFeatures.ScreenSpaceShadows
                    )
                )
                    return true;
            }
        ...
        internal bool StripUnusedFeatures_AdditionalLightShadows(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures_MixedLighting(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (!strippingData.IsShaderFeatureEnabled(ShaderFeatures.MixedLighting))
            {
                ...
                if (
                    strippingData.IsKeywordEnabled(m_LightmapShadowMixing)
                    || strippingData.IsKeywordEnabled(m_ShadowsShadowMask)
                )
                    return true;
            }
        ...
        internal bool StripUnusedFeatures_SoftShadowsQualityLevels(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
            var forcedStrip =
                strippingData.stripSoftShadowQualityLevels
                && (
            ...
            return forcedStrip
                || (
                    stripTool.StripMultiCompileKeepOffVariant(
                        m_SoftShadowsLow,
                        ShaderFeatures.SoftShadowsLow,
                        m_SoftShadowsMedium,
                        ShaderFeatures.SoftShadowsMedium,
                        m_SoftShadowsHigh,
                        ShaderFeatures.SoftShadowsHigh
                    )
                );
        }
        ...
        internal bool StripUnusedFeatures_ReflectionProbes(ref ShaderStripTool<ShaderFeatures> stripTool)
        {
            ...
            if (
                stripTool.StripMultiCompile(m_ReflectionProbeBoxProjection, ShaderFeatures.ReflectionProbeBoxProjection)
            )
                return true;
        ...
        internal bool StripUnusedFeatures_ClusterLightLoop(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (
                !(
                    strippingData.IsShaderFeatureEnabled(ShaderFeatures.ForwardPlus)
                    || strippingData.IsShaderFeatureEnabled(ShaderFeatures.DeferredPlus)
                )
            )
            {
            ...
            {
                if (
                    strippingData.PassHasKeyword(m_ClusterLightLoop)
                    && !strippingData.IsKeywordEnabled(m_ClusterLightLoop)
                )
                    return true;
            }
        ...
        internal bool StripUnusedFeatures_SHAuto(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
            ...
            if (strippingData.IsShaderFeatureEnabled(ShaderFeatures.AutoSHMode))
            {
                if (strippingData.IsShaderFeatureEnabled(ShaderFeatures.AutoSHModePerVertex))
                {
                    ...
                    if (
                        stripTool.StripMultiCompile(
                            m_SHMixed,
                            ShaderFeatures.ExplicitSHMode,
                            m_SHPerVertex,
                            ShaderFeatures.AutoSHModePerVertex
                        )
                    )
                        return true;
                }
        ...
        internal bool StripUnusedFeatures_AdditionalLights(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
            ...
            if (strippingData.IsShaderFeatureEnabled(ShaderFeatures.AdditionalLightsKeepOffVariants))
            {
                if (
                    stripTool.StripMultiCompileKeepOffVariant(
                        m_AdditionalLightsVertex,
                        ShaderFeatures.AdditionalLightsVertex,
        ...
        internal bool StripUnusedFeatures_ScreenSpaceOcclusion(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures_DecalsDbuffer(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
            ...
            if (strippingData.isGLDevice)
            {
                ...
                if (
                    strippingData.IsKeywordEnabled(m_DBufferMRT1)
        ...
        internal bool StripUnusedFeatures_DecalsNormalBlend(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures_DecalLayers(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures_WriteRenderingLayers(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures_AccurateGbufferNormals(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures_LightCookies(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures_ProbesVolumes(ref ShaderStripTool<ShaderFeatures> stripTool)
        {
            return stripTool.StripMultiCompileKeepOffVariant(
                m_ProbeVolumesL1,
                ShaderFeatures.ProbeVolumeL1,
                m_ProbeVolumesL2,
                ShaderFeatures.ProbeVolumeL2
            );
        }
        ...
        internal bool StripUnusedFeatures_CrossFadeLod(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            {
                if (
                    strippingData.IsKeywordEnabled(m_Instancing)
                    || strippingData.IsKeywordEnabled(m_DotsInstancing)
                    || strippingData.IsKeywordEnabled(m_ProceduralInstancing)
                )
                ...
                return strippingData.passType != PassType.ShadowCaster
                    && strippingData.passType != PassType.MotionVectors;
            }

            return !strippingData.IsShaderFeatureEnabled(ShaderFeatures.LODCrossFade);
        }

        internal bool StripUnusedFeatures_PointSamplingUpsampling(
            ref IShaderScriptableStrippingData strippingData,
            ref ShaderStripTool<ShaderFeatures> stripTool
        )
        {
        ...
        internal bool StripUnusedFeatures(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            ShaderStripTool<ShaderFeatures> stripTool = new ShaderStripTool<ShaderFeatures>(
        ...
        *********************************************************/
        ...
        internal bool StripUnsupportedVariants_DirectionalLightmap(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (
                strippingData.IsKeywordEnabled(m_DirectionalLightmap)
        ...
        *********************************************************/
        ...
        internal bool StripInvalidVariants_HDR(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (
                strippingData.IsKeywordEnabled(m_EasuRcasAndHDRInput)
                || strippingData.IsKeywordEnabled(m_Gamma20AndHDRInput)
            )
                return true;
        ...
        {
            if (
                strippingData.shader == m_TerrainLit
                || strippingData.shader == m_TerrainLitAddPass
                || strippingData.shader == m_TerrainLitBasePass
            )
                if (
                    !strippingData.IsShaderFeatureEnabled(ShaderFeatures.TerrainHoles)
                    && strippingData.IsKeywordEnabled(m_AlphaTestOn)
                )
                    return true;
            return false;
        }
        ...
        internal bool StripInvalidVariants_Shadows(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (
                !isShadowVariant
                && (
                    strippingData.IsKeywordEnabled(m_SoftShadows)
        ...
        *********************************************************/
        ...
        internal bool StripUnusedPass_Decals(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            // DBuffer
            if (
                strippingData.passName == DecalShaderPassNames.DBufferMesh
                ...
                if (
                    !strippingData.IsShaderFeatureEnabled(ShaderFeatures.DBufferMRT1)
                    && !strippingData.IsShaderFeatureEnabled(ShaderFeatures.DBufferMRT2)
                    && !strippingData.IsShaderFeatureEnabled(ShaderFeatures.DBufferMRT3)
                )
                    return true;

            // Decal Screen Space
            if (
                strippingData.passName == DecalShaderPassNames.DecalScreenSpaceMesh
                || strippingData.passName == DecalShaderPassNames.DecalScreenSpaceProjector
            )
            ...
            // Decal GBuffer
            if (
                strippingData.passName == DecalShaderPassNames.DecalGBufferMesh
                || strippingData.passName == DecalShaderPassNames.DecalGBufferProjector
            )
