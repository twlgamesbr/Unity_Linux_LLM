...
namespace Unity.Netcode
{
    ...
    public static class NetworkVariableSerializationTypedInitializers
    {
        ...
        public static void InitializeSerializer_UnmanagedByMemcpyList<T>()
            where T : unmanaged
        {
        ...
        public static void InitializeSerializer_NativeHashSet<T>()
        ...
        {
            NetworkVariableSerialization<NativeHashMap<TKey, TVal>>.Serializer =
                new NativeHashMapSerializer<TKey, TVal>();
        }
#endif
        ...
        public static void InitializeSerializer_Dictionary<TKey, TVal>()
        ...
        public static void InitializeSerializer_UnmanagedINetworkSerializableArray<T>()
            where T : unmanaged, INetworkSerializable
        {
            NetworkVariableSerialization<NativeArray<T>>.Serializer =
                new UnmanagedNetworkSerializableArraySerializer<T>();
        }
        ...
        /// </summary>
        /// <typeparam name="T">The unmanaged element type that implements INetworkSerializable</typeparam>
        public static void InitializeSerializer_UnmanagedINetworkSerializableList<T>()
            where T : unmanaged, INetworkSerializable
        {
            NetworkVariableSerialization<NativeList<T>>.Serializer =
                new UnmanagedNetworkSerializableListSerializer<T>();
        }
#endif
        ...
        /// </summary>
        /// <typeparam name="T">The FixedString type that implements INativeList{byte} and IUTF8Bytes</typeparam>
        public static void InitializeSerializer_FixedStringList<T>()
            where T : unmanaged, INativeList<byte>, IUTF8Bytes
        {
        ...
        public static void InitializeEqualityChecker_Dictionary<TKey, TVal>()
            where TKey : IEquatable<TKey>
        {
            NetworkVariableSerialization<Dictionary<TKey, TVal>>.AreEqual = NetworkVariableDictionarySerialization<
                TKey,
                TVal
            >.GenericEqualsDictionary;
        }
        ...
        /// </summary>
        /// <typeparam name="T">The unmanaged element type that implements IEquatable</typeparam>
        public static void InitializeEqualityChecker_UnmanagedIEquatableList<T>()
            where T : unmanaged, IEquatable<T>
        {
        ...
        /// </summary>
        /// <typeparam name="T">The unmanaged element type that implements IEquatable</typeparam>
        public static void InitializeEqualityChecker_NativeHashSet<T>()
            where T : unmanaged, IEquatable<T>
        {
            NetworkVariableSerialization<NativeHashSet<T>>.AreEqual =
                NetworkVariableEquality<T>.EqualityEqualsNativeHashSet;
        }
        ...
        public static void InitializeEqualityChecker_NativeHashMap<TKey, TVal>()
            ...
            where TVal : unmanaged
        {
            NetworkVariableSerialization<NativeHashMap<TKey, TVal>>.AreEqual = NetworkVariableMapSerialization<
                TKey,
                TVal
            >.GenericEqualsNativeHashMap;
        }
#endif
        ...
        /// </summary>
        /// <typeparam name="T">The unmanaged element type to register for equality checking</typeparam>
        public static void InitializeEqualityChecker_UnmanagedValueEqualsList<T>()
            where T : unmanaged
        {
