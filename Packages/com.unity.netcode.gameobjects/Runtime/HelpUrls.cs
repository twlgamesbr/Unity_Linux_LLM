namespace Unity.Netcode.Runtime
{
    internal static class HelpUrls
    {
        private const string k_BaseUrl =
            "https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@latest/?subfolder=/";
        ...
        public const string NetworkRigidbody2D =
            BaseManualUrl + "components/helper/networkrigidbody.html#networkrigidbody2d";
