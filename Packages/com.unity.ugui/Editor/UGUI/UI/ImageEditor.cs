...
namespace UnityEditor.UI
{
    ...
    public class ImageEditor : GraphicEditor
    {
        ...
        void SetShowNativeSize(bool instant)
        {
            ...
            bool showNativeSize =
                (type == Image.Type.Simple || type == Image.Type.Filled) && m_Sprite.objectReferenceValue != null;
        ...
        protected void TypeGUI()
        {
            ...
            ++EditorGUI.indentLevel;
            {
                ...
                bool showSlicedOrTiled = (
                    !m_Type.hasMultipleDifferentValues
                ...
                m_ShowSliced.target = (
                    showSlicedOrTiled && !m_Type.hasMultipleDifferentValues && typeEnum == Image.Type.Sliced
                );
                m_ShowTiled.target = (
                    showSlicedOrTiled && !m_Type.hasMultipleDifferentValues && typeEnum == Image.Type.Tiled
                );
                ...
                if (EditorGUILayout.BeginFadeGroup(m_ShowTiled.faded))
                {
                    if (
                        ...
                        EditorGUILayout.HelpBox(
                            "It looks like you want to tile a sprite with no border. It would be more efficient to remove this Sprite from any SpriteAtlas and set the Wrap mode to Repeat.",
                            MessageType.Warning
                        );
                }
                EditorGUILayout.EndFadeGroup();
