...
#pragma warning disable 0108
        ...
        protected override void UpdateMaterial()
        {
            ...
            if (
                ...
                || m_renderer.sharedMaterial.GetEntityId() != m_sharedMaterial.GetEntityId()
            )
        ...
        protected override void Awake()
        {
            ...
            {
                Debug.LogWarning(
                    "Please remove the CanvasRenderer component from the ["
                        + this.name
                        + "] GameObject as this component is no longer necessary.",
                    this
                );
        ...
        void ON_MATERIAL_PROPERTY_CHANGED(bool isChanged, Material mat)
        {
            ...
            if (m_renderer.sharedMaterial == null)
            {
                if (m_fontAsset != null)
                {
                    ...
                    Debug.LogWarning(
                        "No Material was assigned to " + name + ". " + m_fontAsset.material.name + " was assigned.",
                        this
                    );
                }
                else
                ...
                if (isCharacterVisible)
                {
                    ...
                    switch (elementType)
                    {
                        ...
                        case TMP_TextElementType.Character:
                            ...
                            xScale =
                                characterInfos[i].scale
                                * Mathf.Abs(lossyScale)
                                * (1 - m_charWidthAdjDelta)
                                * m_characterHorizontalScale;
                            if (
