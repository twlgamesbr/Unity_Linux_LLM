...
namespace TMPro
{
    public class TMP_TextParsingUtilities
    {
        ...
        {
            // ZWJ + VS1..VS16 + (optional) Variation Selectors Supplement
            return cp == 0x200D                             // ZWJ
                   || (cp >= 0xFE00 && cp <= 0xFE0F)        // VS1..VS16
                   || (cp >= 0xE0100 && cp <= 0xE01EF);     // VS17..VS256 (supplement)
        }
        ...
        {
            // Han Ideographs and Extensions (Unified CJK)
            if ((c >= 0x4E00 && c <= 0x9FFF) ||     // CJK Unified Ideographs
                ...
                (c >= 0x31350 && c <= 0x323AF))     // CJK Extension H
                return true;

            // CJK Compatibility Ideographs
            if ((c >= 0xF900 && c <= 0xFAFF) ||     // Compatibility Ideographs
                (c >= 0x2F800 && c <= 0x2FA1F))     // Compatibility Ideographs Supplement
                return true;
            ...
            // Chinese phonetics (Zhuyin/Bopomofo)
            if ((c >= 0x3100 && c <= 0x312F) ||     // Bopomofo
                (c >= 0x31A0 && c <= 0x31BF))       // Bopomofo Extended
                return true;

            // Radicals, Description Characters, Strokes
            if ((c >= 0x2E80 && c <= 0x2EFF) ||     // CJK Radicals Supplement
            ...
            if ((c >= 0x3000 && c <= 0x303F) ||     // CJK Symbols and Punctuation
                ...
                (c >= 0x16FE0 && c <= 0x16FFF))     // Ideographic Symbols and Punctuation
                return true;

            // Compatibility Forms and Halfwidth / Fullwidth
            if ((c >= 0xFE10 && c <= 0xFE1F) ||    // Vertical Forms
                (c >= 0xFE30 && c <= 0xFE4F) ||    // CJK Compatibility Forms
                (c >= 0xFE50 && c <= 0xFE6F) ||    // Small Form Variants
                (c >= 0xFF65 && c <= 0xFF9F))      // Halfwidth Katakana (JP)
                return true;
