...
namespace TMPro
{
    ...
    public class TMP_SpriteAsset : TMP_Asset
    {
        ...
        /// <returns></returns>
        public static TMP_SpriteAsset SearchForSpriteByUnicode(
        ...
        )
        {
            ...
            if (
                includeFallbacks
                && spriteAsset.fallbackSpriteAssets != null
        ...
        /// <returns></returns>
        private static TMP_SpriteAsset SearchForSpriteByUnicodeInternal(
            List<TMP_SpriteAsset> spriteAssets,
            uint unicode,
            bool includeFallbacks,
            out int spriteIndex
        )
        ...
        public static TMP_SpriteAsset SearchForSpriteByHashCode(
            TMP_SpriteAsset spriteAsset,
            int hashCode,
            bool includeFallbacks,
            out int spriteIndex
        )
        {
            ...
            {
                tempSpriteAsset = SearchForSpriteByHashCodeInternal(
                    spriteAsset.fallbackSpriteAssets,
                    hashCode,
                    true,
                    out spriteIndex
            ...
            {
                tempSpriteAsset = SearchForSpriteByUnicodeInternal(
                    spriteAsset.fallbackSpriteAssets,
        ...
        /// <param name="spriteIndex"></param>
        /// <returns></returns>
        private static TMP_SpriteAsset SearchForSpriteByHashCodeInternal(
            List<TMP_SpriteAsset> spriteAssets,
            int hashCode,
