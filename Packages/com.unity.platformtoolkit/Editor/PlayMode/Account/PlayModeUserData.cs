...
namespace Unity.PlatformToolkit.PlayMode
{
    ...
    {
        [SerializeReference]
        private List<PlayModeAccountData> m_SignedInAccounts = new();

        [SerializeReference]
        private List<PlayModeAccountData> m_AccountData = new();

        [SerializeReference]
        private PlayModeAccountData m_PrimaryAccountData;
        ...
        public PlayModeUserData()
            : this(Array.Empty<PlayModeAccountData>()) { }
