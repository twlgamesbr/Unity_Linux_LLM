...
namespace Unity.PlatformToolkit.PlayMode
{
    ...
    internal partial class PlayModeControlsSettingsField : VisualElement
    {
        ...
        private HelpBox m_HelpBox = new HelpBox(
            "Create a Play Mode Controls asset to see test account data.",
            HelpBoxMessageType.Info
        );

        public PlayModeControlsSettingsField()
        {
            m_SettingsField = new ObjectField { objectType = typeof(PlayModeControlsSettings) };
            Add(m_SettingsField);
            ...
            m_CreateSettingsButton = new Button { text = "Create Play Mode Controls Settings" };
        ...
        private void CreateSettingsAsset()
        {
            var path = EditorUtility.SaveFilePanelInProject(
                "Create Play Mode Controls Settings",
                "PlayModeControlsSettings",
                "asset",
                ""
            );
