...
namespace Unity.PlatformToolkit.PlayMode
{
    ...
    internal partial class PlayModeControlsAccountAttributeValueInputCell : VisualElement, INotifyValueChanged<object>
    {
        ...
        private void UpdateUI()
        {
            ...
            {
                throw new NotSupportedException($"Serialization not implemented for type: {valueType?.FullName ?? "null"}");
            }
            Clear();
            Add(valueField);
        }
