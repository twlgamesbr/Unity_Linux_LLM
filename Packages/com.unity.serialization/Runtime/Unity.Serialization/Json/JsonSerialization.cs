...
namespace Unity.Serialization.Json
{
    ...
    class JsonSerializationState
    {
        ...
        internal bool IsLocked =>
            (m_JsonPropertyWriter != null && m_JsonPropertyWriter.IsLocked)
            || (m_JsonPropertyReader != null && m_JsonPropertyReader.IsLocked);
        ...
        /// </summary>
        internal void ClearSerializedReferences() => m_SerializedReferences?.Clear();

        /// <summary>
        /// Clears the deserialization events state.
        /// </summary>
        internal void ClearDeserializationEvents() => m_DeserializationEvents?.Clear();
    }
