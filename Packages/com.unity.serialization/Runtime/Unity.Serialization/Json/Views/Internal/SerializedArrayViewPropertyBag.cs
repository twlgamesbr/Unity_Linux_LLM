...
{
    class SerializedArrayViewPropertyBag
        : PropertyBag<SerializedArrayView>,
            IListPropertyBag<SerializedArrayView, SerializedValueView>
    {
        ...
        class Property : Property<SerializedArrayView, SerializedValueView>, IListElementProperty
        {
            ...
            public override SerializedValueView GetValue(ref SerializedArrayView container) => m_View;
        ...
        readonly struct Enumerable : IEnumerable<IProperty<SerializedArrayView>>
        {
            ...
            public Enumerable(SerializedArrayView container) => m_Container = container;

            public IEnumerator<IProperty<SerializedArrayView>> GetEnumerator() =>
                new Enumerator(m_Container.GetEnumerator());

            IEnumerator IEnumerable.GetEnumerator() => new Enumerator(m_Container.GetEnumerator());
        }
        ...
        bool IIndexedProperties<SerializedArrayView>.TryGetProperty(
            ref SerializedArrayView container,
            int index,
            out IProperty<SerializedArrayView> property
        )
        {
        ...
        void ICollectionPropertyBagAccept<SerializedArrayView>.Accept(
        ...
        void IListPropertyBagAccept<SerializedArrayView>.Accept(
            IListPropertyBagVisitor visitor,
            ref SerializedArrayView container
        )
        {
            visitor.Visit(this, ref container);
        ...
        void IListPropertyAccept<SerializedArrayView>.Accept<TContainer>(
            IListPropertyVisitor visitor,
            Property<TContainer, SerializedArrayView> property,
            ref TContainer container,
            ref SerializedArrayView list
        )
        {
