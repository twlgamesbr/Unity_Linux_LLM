...
{
    /// <summary>
    /// A PrebuildSetupWithTestData attribute runs if the test or test class is in the current test run. The test is included either by running all tests or setting a filter that includes the test. If multiple tests reference the same pre-build setup or post-build cleanup, then it only runs once.
    /// </summary>
    [AttributeUsage(AttributeTargets.Assembly | AttributeTargets.Class | AttributeTargets.Method)]
    public class PrebuildSetupWithTestDataAttribute : Attribute
    {
        /// <summary>
        ///  Initializes and returns an instance of PrebuildSetupWithTestDataAttribute by type.
        /// </summary>
        /// <param name="targetClass">The type of the target class.</param>
        public PrebuildSetupWithTestDataAttribute(Type targetClass)
        {
            TargetClass = targetClass;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="PrebuildSetupWithTestDataAttribute"/> class with a target class name.
        /// </summary>
        ...
        ///     Sprite m_Sprite;
        ///
        ///     public void Setup(TestData testRun)
        ///     {
        ///         #if UNITY_EDITOR
        ///
