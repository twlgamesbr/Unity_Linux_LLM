...
namespace UnityEditor.TestRunner
{
    ...
    internal class TestBuildAssemblyFilter : IFilterBuildAssemblies
    {
        ...
        {
            if (
                (buildOptions & BuildOptions.IncludeTestAssemblies) == BuildOptions.IncludeTestAssemblies
            ...
            return assemblies
                .Where(x => !x.Contains(nunitAssemblyName) && !x.Contains(unityTestRunnerAssemblyName))
                .ToArray();
        }
    }
}
