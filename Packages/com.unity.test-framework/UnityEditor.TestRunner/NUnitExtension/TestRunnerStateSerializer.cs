...
namespace UnityEditor.TestTools.TestRunner
{
    ...
    internal class TestRunnerStateSerializer : IStateSerializer
    {
        ...
        [SerializeField]
        private bool m_IgnoreFailingMessages;
        ...
        public void SaveContext()
        {
            ...
            ErrorCount = currentContext.GetErrorCount();
            if (LogScope.HasCurrentLogScope())
            {
                m_ExpectedLogs = LogScope.Current.ExpectedLogs.ToArray();
                m_IgnoreFailingMessages = LogScope.Current.IgnoreFailingMessages;
            }
        ...
        public void RestoreContext()
        {
            ...
            currentContext.ErrorCount = ErrorCount;
            if (LogScope.HasCurrentLogScope())
            {
