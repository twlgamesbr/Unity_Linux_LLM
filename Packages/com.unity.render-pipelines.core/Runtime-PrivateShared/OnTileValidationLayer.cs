    ...
    internal sealed class OnTileValidationLayer : RenderGraphValidationLayer
    {
        ...
        struct Pass
        {
            ...
            public void Init()
            {
                ...
                globalTexturesAfterPass = new NativeList<TextureHandle>(
                    k_InitialGlobalTexturesAfterPass,
        ...
        const string k_ErrorMessageHowToResolveDefault =
            "Disable the On-Tile Validation Layer or ensure that all render passes meet the constraints of this layer.\n";
        ...
        void ValidateNoNonRasterPassInbetween(in TextureHandle input)
        {
            ...
            if (
                lastRasterPass != k_TrackedNotYetUsed
                && m_LastNonRasterPassIndex > lastRasterPass
        ...
        void ThrowNoNonRasterPassInBetween(in TextureHandle input)
        {
            ...
            throw new InvalidOperationException(
                $"{k_ErrorMessageValidationIssue} render pass '{m_CurrentPass.info.name}'"
        ...
        void ThrowTextureSamplingException(in TextureHandle input, string methodName)
        {
            var resourceName = renderGraph.GetTextureName(in input);
            throw new InvalidOperationException(
                $"{k_ErrorMessageValidationIssue} render pass '{m_CurrentPass.info.name}' calls '{methodName}' with resource '{resourceName}'.\n{errorMessageHowToResolve}"
            );
        }
        ...
        public override void UseTexture(in TextureHandle input, AccessFlags flags)
        {
        ...
        public override void SetGlobalTextureAfterPass(in TextureHandle input, int propertyId)
        {
        ...
        public override void SetRenderAttachment(
            TextureHandle tex,
            int index,
            AccessFlags flags,
            int mipLevel,
        ...
        public override void SetRenderAttachmentDepth(
            TextureHandle tex,
            AccessFlags flags,
            int mipLevel,
            int depthSlice
        ...
        public override void SetInputAttachment(
            TextureHandle tex,
            int index,
            AccessFlags flags,
            int mipLevel,
        ...
        public override void OnPassAddedBegin(in RenderPassInfo renderPassInfo)
        {
            m_CurrentPass.Clear();
        ...
        public override void OnPassAddedDispose()
        {
