...
namespace UnityEditor.Rendering
{
    public static partial class SerializedBitArrayUtilities
    {
        ...
        [Obsolete("Since SerializedBitArray unification, only use SerializedBitArrayAny. #from(23.2)")]
        public static bool TryGetSerializeBitArray8(
            this SerializedProperty serializedProperty,
            out SerializedBitArray8 serializedBitArray
        )
        {
        ...
        /// <returns>True if convertion was a success</returns>
        [Obsolete("Since SerializedBitArray unification, only use SerializedBitArrayAny. #from(23.2)")]
        public static bool TryGetSerializeBitArray16(
            this SerializedProperty serializedProperty,
            out SerializedBitArray16 serializedBitArray
        )
        {
            serializedBitArray = null;
            return false;
        ...
        /// <returns>True if convertion was a success</returns>
        [Obsolete("Since SerializedBitArray unification, only use SerializedBitArrayAny. #from(23.2)")]
        public static bool TryGetSerializeBitArray32(
            this SerializedProperty serializedProperty,
            out SerializedBitArray32 serializedBitArray
        )
        {
            serializedBitArray = null;
            return false;
        ...
        /// <returns>True if convertion was a success</returns>
        [Obsolete("Since SerializedBitArray unification, only use SerializedBitArrayAny. #from(23.2)")]
        public static bool TryGetSerializeBitArray64(
            this SerializedProperty serializedProperty,
            out SerializedBitArray64 serializedBitArray
        )
        {
            serializedBitArray = null;
            return false;
        ...
        /// <returns>True if convertion was a success</returns>
        [Obsolete("Since SerializedBitArray unification, only use SerializedBitArrayAny. #from(23.2)")]
        public static bool TryGetSerializeBitArray128(
            this SerializedProperty serializedProperty,
            out SerializedBitArray128 serializedBitArray
        )
        {
            serializedBitArray = null;
            return false;
        ...
        /// <returns>True if convertion was a success</returns>
        [Obsolete("Since SerializedBitArray unification, only use SerializedBitArrayAny. #from(23.2)")]
        public static bool TryGetSerializeBitArray256(
            this SerializedProperty serializedProperty,
            out SerializedBitArray256 serializedBitArray
        )
        {
            serializedBitArray = null;
            return false;
    ...
    public abstract class SerializedBitArray : ISerializedBitArray
    {
        ...
        /// <summary>Set the bit at given index</summary>
        [Obsolete(
            "Was only working under specific 32 bit mask size. Removed for disambiguisation. Use SetBitAt instead. #from(23.2)"
        )]
        ...
        [Obsolete(
            "Was only working under specific 32 bit mask size. Removed for disambiguisation. Use HasBitMultipleDifferentValueBitwise_For64BitsOrLess instead. #from(23.2)"
        )]
        ...
        [Obsolete(
            "As it is required to discompose per target to isolate works per bit, this cannot be used when there is multiple selection. #from(23.2)"
        )]
        ...
        protected SerializedProperty[] GetOrInitializeSerializedProperties() => new SerializedProperty[] { };

        /// <summary>Say if the properties have differente values</summary>
        /// <param name="bitIndex">The index</param>
        /// <returns>True: properties have different value</returns>
        [Obsolete(
            "Replaced by an autocasting to 64 bit buckets for all IBitArray. Now difference computation is not implementation specific anymore #from(23.2)"
        )]
        ...
        [Obsolete(
            "Replaced by HasBitMultipleDifferentValue that now works for all IBitArray implementations. #from(23.2)"
        )]
        protected unsafe bool HasBitMultipleDifferentValue_For64Bits(
            string propertyPath,
        ...
        protected virtual bool GetBitAt_Internal(uint bitIndex) => GetBitAt(bitIndex);

        /// <summary>Set the bit at given index</summary>
        /// <param name="bitIndex">The index</param>
        /// <param name="value">The value</param>
        [Obsolete("Replaced by SetBitAt that now works for all IBitArray implementations. #from(23.2)")]
        protected virtual void SetBitAt_Internal(uint bitIndex, bool value) => SetBitAt(bitIndex, value);
    ...
    public sealed class SerializedBitArray8 : SerializedBitArray
    {
        ...
        public SerializedBitArray8(SerializedProperty serializedProperty, uint capacity)
            : base(serializedProperty, capacity) { }
    ...
    {
        /// <inheritdoc cref="SerializedBitArray"/>
        public SerializedBitArray16(SerializedProperty serializedProperty, uint capacity)
            : base(serializedProperty, capacity) { }
    ...
    {
        /// <inheritdoc cref="SerializedBitArray"/>
        public SerializedBitArray32(SerializedProperty serializedProperty, uint capacity)
            : base(serializedProperty, capacity) { }
    ...
    {
        /// <inheritdoc cref="SerializedBitArray"/>
        public SerializedBitArray64(SerializedProperty serializedProperty, uint capacity)
            : base(serializedProperty, capacity) { }
    ...
    {
        /// <inheritdoc cref="SerializedBitArray"/>
        public SerializedBitArray256(SerializedProperty serializedProperty, uint capacity)
            : base(serializedProperty, capacity) { }
