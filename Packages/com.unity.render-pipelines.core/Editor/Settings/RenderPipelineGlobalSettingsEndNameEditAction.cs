...
namespace UnityEditor.Rendering
{
    ...
    /// </summary>
    [Obsolete(
        "RenderPipelineGlobalSettingsEndNameEditAction is no longer used and will be removed in a future release."
    )]
    public class RenderPipelineGlobalSettingsEndNameEditAction : ProjectWindowCallback.AssetCreationEndAction
    {
        ...
        {
            RenderPipelineGlobalSettings assetCreated =
                RenderPipelineGlobalSettingsUtils.Create(renderPipelineGlobalSettingsType, pathName, source)
        ...
        internal static RenderPipelineGlobalSettingsEndNameEditAction CreateEndNameEditAction(
            ...
            bool updateAssetOnGraphicsSettings,
            RenderPipelineGlobalSettings source = null
        )
        {
        ...
        internal static void StartEndNameEditAction(
            RenderPipelineGlobalSettingsEndNameEditAction action,
            string pathName
        )
        {
        ...
        public static void CreateNew<TRenderPipeline, TGlobalSettings>(
            bool usePathFromCurrentSettings = false,
            bool updateAssetOnGraphicsSettings = false
        )
            ...
            where TGlobalSettings : RenderPipelineGlobalSettings
        {
            ...
            StartEndNameEditAction(
                CreateEndNameEditAction(
                    typeof(TRenderPipeline),
                    typeof(TGlobalSettings),
                    updateAssetOnGraphicsSettings
                ),
                pathName
            );
        }

        internal static void CloneFrom<TRenderPipeline, TGlobalSettings>(
