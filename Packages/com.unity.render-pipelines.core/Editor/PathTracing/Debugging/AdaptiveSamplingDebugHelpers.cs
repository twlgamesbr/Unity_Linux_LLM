...
namespace UnityEditor.PathTracing.Debugging
{
    internal static class AdaptiveSamplingDebugHelpers
    {
        ...
        internal static void LogTotalSamplesTaken(
            CommandBuffer cmd,
            LightmapIntegrationHelpers.ComputeHelpers helpers,
            RenderTexture accumulatedOutput,
            uint maxSampleCount
        )
        {
            ...
            Debug.Log(
                $"total samples taken:\t{totalSampleSum}\tout of: \t{maxSampleSum}\tfraction:\t{(double)totalSampleSum / (double)maxSampleSum}"
            );
        }

        internal static LightmapIntegrationHelpers.AdaptiveSample GetAdaptiveSample(
            CommandBuffer cmd,
            LightmapIntegrationHelpers.ComputeHelpers helpers,
            RenderTexture accumulatedOutput,
            RenderTexture adaptiveOutput,
            int sampleX,
            int sampleY
        )
        {
            Debug.Assert(
                accumulatedOutput.width == adaptiveOutput.width && accumulatedOutput.height == adaptiveOutput.height
            );
            var width = adaptiveOutput.width;
            var height = adaptiveOutput.height;

            Color accumulatedOutputValue = LightmapIntegrationHelpers.GetValue(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.GetValueKernel,
                sampleX,
                sampleY,
                width,
                height,
            ...
            Color adaptiveOutputValue = LightmapIntegrationHelpers.GetValue(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.GetValueKernel,
                sampleX,
        ...
        internal static void WriteAdaptiveDebugImages(
            string path,
        ...
        )
        {
            ...
            WriteSampleCount(
                ...
                accumulatedOutput,
                totalSampleCount,
                $"{path}/sampleCount_{filenamePostfix}.r2d"
            );
            ...
            WriteFilteredVariance(
                cmd,
                helpers,
                adaptiveOutput,
                varianceScale,
                $"{path}/varianceFiltered_{filenamePostfix}.r2d"
            );
        ...
        )
        {
            ...
            LightmapIntegrationHelpers.NormalizeByAlpha(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.NormalizeByAlphaKernel,
                width,
                height,
                tempRTID
            );
            LightmapIntegrationHelpers.SetChannelRenderTexture(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.SetChannelKernel,
                tempRTID,
                width,
                height,
                3,
        ...
        )
        {
            ...
            cmd.CopyTexture(accumulatedOutput, tempRTID);
            LightmapIntegrationHelpers.BroadcastChannelRenderTexture(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.BroadcastChannelKernel,
                tempRTID,
                width,
                height,
                3
            ...
            LightmapIntegrationHelpers.MultiplyRenderTexture(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.MultiplyKernel,
                tempRTID,
                width,
                height,
                new Vector4(samplesScale, samplesScale, samplesScale, 1.0f)
            );
            SerializationHelpers.WriteRenderTexture(cmd, tempRTID, TextureFormat.RGBAFloat, width, height, filename);
        ...
        )
        {
            ...
            LightmapIntegrationHelpers.MultiplyRenderTexture(
                ...
                width,
                height,
                new Vector4(scale, scale, scale, 1.0f)
            );
            SerializationHelpers.WriteRenderTexture(cmd, tempRTID, TextureFormat.RGBAFloat, width, height, filename);
        ...
        static void WriteFilteredVariance(
            CommandBuffer cmd,
            LightmapIntegrationHelpers.ComputeHelpers helpers,
            RenderTexture adaptiveOutput,
            float scale,
        ...
        )
        {
            ...
            cmd.CopyTexture(adaptiveOutput, tempRTID);
            LightmapIntegrationHelpers.ReferenceBoxFilterRenderTexture(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.ReferenceBoxFilterBlueChannelKernel,
                tempRTID,
                width,
                height,
                2
        ...
        static void WriteStandardError(
            CommandBuffer cmd,
            LightmapIntegrationHelpers.ComputeHelpers helpers,
            RenderTexture adaptiveOutput,
            float scale,
        ...
        static int GetActiveTexelImage(
            CommandBuffer cmd,
            LightmapIntegrationHelpers.ComputeHelpers helpers,
            RenderTexture adaptiveOutput,
            float adaptiveThreshold
        )
        {
            ...
            LightmapIntegrationHelpers.StandardErrorThresholdRenderTexture(
                cmd,
                helpers.ComputeHelperShader,
                LightmapIntegrationHelpers.ComputeHelpers.StandardErrorThresholdKernel,
                tempRTID,
                adaptiveOutput,
                adaptiveThreshold,
                secondTempRTID,
        ...
        static UInt64 GetSampleCountSum(
            CommandBuffer cmd,
            LightmapIntegrationHelpers.ComputeHelpers helpers,
            RenderTexture accumulatedOutput
        )
        {
            ...
            var temporaryRT = new RenderTexture(
                width,
                height,
                0,
                RenderTextureFormat.ARGBFloat,
            ...
            {
                name = "temporaryRT (GetSampleCountSum)",
