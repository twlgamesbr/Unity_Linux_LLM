...
namespace UnityEditor.Rendering
{
    ...
    sealed class VolumeEditor : Editor
    {
        ...
        static class Styles
        {
            ...
            public static readonly GUIContent addColliderFixMessage = EditorGUIUtility.TrTextContentWithIcon(
                "Add a Collider to this GameObject to set boundaries for the local Volume.",
                CoreEditorStyles.iconWarn
            );
            public static readonly GUIContent disableColliderFixMessage = EditorGUIUtility.TrTextContentWithIcon(
                "Global Volumes do not need a collider. Disable or remove the collider.",
                CoreEditorStyles.iconWarn
            );
            public static readonly GUIContent physicsBackendDisabledMessage = EditorGUIUtility.TrTextContentWithIcon(
            ...
            public static readonly GUIContent physicsModuleDisabledMessage = EditorGUIUtility.TrTextContentWithIcon(
                "Local Volumes are unavailable without the Physics module. Enable the Physics module, or set the Mode to Global.",
                CoreEditorStyles.iconWarn
            );
            public static readonly GUIContent enableColliderFixMessage = EditorGUIUtility.TrTextContentWithIcon(
        ...
        VolumeProfile profileRef =>
            targetVolume.HasInstantiatedProfile() ? targetVolume.profile : targetVolume.sharedProfile;
        ...
        void UpdateElementVisibility(VisualElement root)
        {
            ...
            root.Q<Button>("volume-profile-new-button").style.display =
                profileRef != null ? DisplayStyle.None : DisplayStyle.Flex;
            root.Q<Label>("volume-profile-instance-profile-label").style.display = targetVolume.HasInstantiatedProfile()
                ? DisplayStyle.Flex
                : DisplayStyle.None;
        }
