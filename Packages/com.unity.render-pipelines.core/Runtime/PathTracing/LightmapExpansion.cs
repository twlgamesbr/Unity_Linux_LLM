...
namespace UnityEngine.PathTracing.Lightmapping
{
    ...
    {
        internal static int PopulateAccumulationIndirectDispatch(
            CommandBuffer cmd,
            IRayTracingShader accumulationShader,
            ComputeShader populateShader,
            int populateKernel,
            uint expandedSampleWidth,
            GraphicsBuffer compactedGbufferLength,
            GraphicsBuffer accumulationDispatchBuffer
        )
        {
            cmd.SetComputeIntParam(
                populateShader,
                ExpansionShaderIDs.ExpandedTexelSampleWidth,
                (int)expandedSampleWidth
            );
            cmd.SetComputeBufferParam(
                populateShader,
                populateKernel,
                ExpansionShaderIDs.CompactedGBufferLength,
                compactedGbufferLength
            );
            cmd.SetComputeBufferParam(
                populateShader,
                populateKernel,
                ExpansionShaderIDs.AccumulationDispatchBuffer,
                accumulationDispatchBuffer
            );
        ...
        internal static int PopulateClearExpandedOutputIndirectDispatch(
            CommandBuffer cmd,
            ComputeShader populateClearDispatch,
            int populateClearDispatchKernel,
            uint clearThreadGroupSizeX,
            uint expandedSampleWidth,
            GraphicsBuffer compactedGBufferLength,
            GraphicsBuffer clearDispatchBuffer
        )
        {
            ...
            cmd.SetComputeIntParam(
                populateClearDispatch,
                ExpansionShaderIDs.ThreadGroupSizeX,
                (int)clearThreadGroupSizeX
            );
            cmd.SetComputeBufferParam(
                populateClearDispatch,
            ...
            cmd.SetComputeBufferParam(
                populateClearDispatch,
                populateClearDispatchKernel,
                ExpansionShaderIDs.ClearDispatchBuffer,
                clearDispatchBuffer
            );
        ...
        internal static int ClearExpandedOutput(
            CommandBuffer cmd,
            ComputeShader clearExpandedOutput,
            int clearExpandedOutputKernel,
        ...
        )
        {
            ...
            cmd.SetComputeBufferParam(
                clearExpandedOutput,
                clearExpandedOutputKernel,
                ExpansionShaderIDs.Float4Buffer,
                expandedOutput
            );
        ...
        internal static void GenerateGBuffer(
            CommandBuffer cmd,
        ...
        )
        {
            ...
            gBufferShader.SetIntParam(
                cmd,
                LightmapIntegratorShaderIDs.StochasticAntialiasing,
                stochasticAntiAliasing ? 1 : 0
            );
            gBufferShader.SetIntParam(cmd, LightmapIntegratorShaderIDs.SuperSampleWidth, (int)superSampleWidth);

            // dispatch the shader
            Debug.Assert(
                gBufferShader is HardwareRayTracingShader
                    || GraphicsHelpers.DivUp((int)chunkSize, gBufferShader.GetThreadGroupSizes().x) < 65536,
                "Chunk size is too large for the shader to handle."
            );
        ...
        internal static float2[] DebugGBuffer(
            CommandBuffer cmd,
        ...
        )
        {
            ...
            var lightmapSamplesExpanded = new GraphicsBuffer(
        ...
        internal static int CompactGBuffer(
            CommandBuffer cmd,
            ComputeShader compactGBuffer,
            int compactGBufferKernel,
            uint instanceWidth,
            uint chunkSize,
            uint2 chunkOffset,
            UVFallbackBuffer uvFallbackBuffer,
        ...
        )
        {
            ...
            cmd.SetComputeTextureParam(
                compactGBuffer,
                compactGBufferKernel,
                UVFallbackBufferBuilderShaderIDs.UvFallback,
                uvFallbackBuffer.UVFallbackRT
            );
            cmd.SetComputeBufferParam(
                compactGBuffer,
                compactGBufferKernel,
                ExpansionShaderIDs.CompactedGBuffer,
            ...
            cmd.DispatchCompute(
                compactGBuffer,
                compactGBufferKernel,
                GraphicsHelpers.DivUp((int)chunkSize, gbuf_x),
                1,
                1
            );
        ...
        internal static int PopulateReduceExpandedOutputIndirectDispatch(
            CommandBuffer cmd,
            ComputeShader populateReduceExpandedOutput,
            int populateReduceExpandedOutputKernel,
            uint reduceThreadGroupSizeX,
            uint expandedSampleWidth,
            GraphicsBuffer compactedGBufferLength,
            GraphicsBuffer reduceDispatchBuffer
        )
        {
            // Populate the reduce copy indirect dispatch buffer - using the compacted size.
            cmd.SetComputeIntParam(
                populateReduceExpandedOutput,
                ExpansionShaderIDs.ExpandedTexelSampleWidth,
                (int)expandedSampleWidth
            );
            cmd.SetComputeIntParam(
            ...
            cmd.SetComputeBufferParam(
                populateReduceExpandedOutput,
                populateReduceExpandedOutputKernel,
                ExpansionShaderIDs.ReduceDispatchBuffer,
                reduceDispatchBuffer
            );
        ...
        internal static int ReduceExpandedOutput(
            CommandBuffer cmd,
            ComputeShader binaryGroupSumLeftShader,
            int binaryGroupSumLeftKernel,
            GraphicsBuffer expandedOutput,
            int expandedDispatchSize,
            uint expandedSampleWidth,
            GraphicsBuffer reduceDispatch
        )
        {
        ...
        internal static int PopulateCopyToLightmapIndirectDispatch(
            CommandBuffer cmd,
            ComputeShader populateCopyToLightmap,
            int populateCopyToLightmapKernel,
            uint copyThreadGroupSizeX,
            GraphicsBuffer compactedGBufferLength,
            GraphicsBuffer copyDispatch
        )
        {
            // Populate the expanded copy indirect dispatch buffer - using the compacted size.
            cmd.SetComputeIntParam(
                populateCopyToLightmap,
                ExpansionShaderIDs.ThreadGroupSizeX,
                (int)copyThreadGroupSizeX
            );
            cmd.SetComputeBufferParam(
                populateCopyToLightmap,
                populateCopyToLightmapKernel,
                ExpansionShaderIDs.CompactedGBufferLength,
                compactedGBufferLength
            );
            cmd.SetComputeBufferParam(
                populateCopyToLightmap,
                populateCopyToLightmapKernel,
                ExpansionShaderIDs.CopyDispatchBuffer,
                copyDispatch
            );
        ...
        internal static int CopyToLightmap(
            CommandBuffer cmd,
            ComputeShader copyToLightmap,
            int copyToLightmapKernel,
            uint expandedSampleWidth,
            int instanceWidth,
            Vector2Int instanceTexelOffset,
            uint2 chunkOffset,
        ...
        )
        {
            cmd.SetComputeBufferParam(
                ...
                ExpansionShaderIDs.SourceBuffer,
                expandedOutput
            );
            ...
            cmd.SetComputeTextureParam(
                copyToLightmap,
                copyToLightmapKernel,
                ExpansionShaderIDs.DestinationTexture,
                output
            );
            cmd.SetComputeBufferParam(
                copyToLightmap,
