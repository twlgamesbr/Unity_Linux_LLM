...
namespace UnityEngine.Rendering
{
    ...
    public class UnsafeCommandBuffer : BaseCommandBuffer, IUnsafeCommandBuffer
    {
        ...
        {
            m_WrappedCommandBuffer.RequestAsyncReadback(
                src,
                mipIndex,
                x,
                width,
        ...
        public void RequestAsyncReadbackIntoNativeArray<T>(
            ...
            where T : struct
        {
            m_WrappedCommandBuffer.RequestAsyncReadbackIntoNativeArray(
                ref output,
                src,
                mipIndex,
                x,
        ...
        public void MarkLateLatchMatrixShaderPropertyID(
        ...
        {
            m_WrappedCommandBuffer.BeginSample(marker);
        }
        ...
        {
            m_WrappedCommandBuffer.EndSample(marker);
        }
        ...
        {
            m_WrappedCommandBuffer.SetRenderTarget(
                rt,
                colorLoadAction,
                colorStoreAction,
                depthLoadAction,
        ...
        {
            m_WrappedCommandBuffer.SetBufferData(
                buffer,
                data,
        ...
        {
            m_WrappedCommandBuffer.DispatchCompute(
                computeShader,
                kernelIndex,
                threadGroupsX,
                threadGroupsY,
        ...
        {
            m_WrappedCommandBuffer.SetRayTracingAccelerationStructure(
                rayTracingShader,
                name,
        ...
        {
            m_WrappedCommandBuffer.DrawMultipleMeshes(
                matrices,
                meshes,
                subsetIndices,
                count,
        ...
        {
            m_WrappedCommandBuffer.DrawProcedural(
                matrix,
                material,
                shaderPass,
                topology,
        ...
        {
            m_WrappedCommandBuffer.DrawProceduralIndirect(
                matrix,
                material,
                shaderPass,
                topology,
        ...
        {
            m_WrappedCommandBuffer.DrawMeshInstanced(
                mesh,
                submeshIndex,
                material,
                shaderPass,
        ...
        {
            m_WrappedCommandBuffer.DrawMeshInstancedProcedural(
                mesh,
                submeshIndex,
                material,
                shaderPass,
        ...
        {
            m_WrappedCommandBuffer.DrawMeshInstancedIndirect(
                mesh,
                submeshIndex,
                material,
                shaderPass,
        ...
        {
            m_WrappedCommandBuffer.CopyTexture(
                src,
                srcElement,
                srcMip,
                srcX,
