...
namespace UnityEngine.Rendering
{
    ...
    public struct BitArray8 : IBitArray
    {
        ...
        public string humanizedData =>
            String.Format("{0, " + capacity + "}", Convert.ToString(data, 2)).Replace(' ', '0');
    ...
    public struct BitArray64 : IBitArray
    {
        ...
        public string humanizedData =>
            System
                .Text.RegularExpressions.Regex.Replace(
                    String.Format("{0, " + capacity + "}", Convert.ToString((long)data, 2)).Replace(' ', '0'),
                    ".{8}",
                    "$0."
                )
                .TrimEnd('.');
    ...
    public struct BitArray128 : IBitArray
    {
        ...
        public string humanizedData =>
            System.Text.RegularExpressions.Regex.Replace(
                String.Format("{0, " + 64u + "}", Convert.ToString((long)data2, 2)).Replace(' ', '0'),
                ".{8}",
                "$0."
            )
            + System
                .Text.RegularExpressions.Regex.Replace(
                    String.Format("{0, " + 64u + "}", Convert.ToString((long)data1, 2)).Replace(' ', '0'),
                    ".{8}",
                    "$0."
                )
                .TrimEnd('.');
        ...
        public bool this[uint index]
        {
            get => index < 64u ? (data1 & (1uL << (int)index)) != 0uL : (data2 & (1uL << (int)(index - 64u))) != 0uL;
            set
            {
                if (index < 64u)
        ...
        public static BitArray128 operator |(BitArray128 a, BitArray128 b) =>
            new BitArray128(a.data1 | b.data1, a.data2 | b.data2);
        ...
        public override bool Equals(object obj) =>
            obj is BitArray128 ba128 && data1.Equals(ba128.data1) && data2.Equals(ba128.data2);
    ...
    public struct BitArray256 : IBitArray
    {
        ...
        /// <summary>True if all bits are 1.</summary>
        public bool allTrue =>
            data1 == ulong.MaxValue && data2 == ulong.MaxValue && data3 == ulong.MaxValue && data4 == ulong.MaxValue;

        /// <summary>Returns the bit array in a human readable form.</summary>
        public string humanizedData =>
            System.Text.RegularExpressions.Regex.Replace(
                String.Format("{0, " + 64u + "}", Convert.ToString((long)data4, 2)).Replace(' ', '0'),
                ".{8}",
                "$0."
            )
            + System.Text.RegularExpressions.Regex.Replace(
                String.Format("{0, " + 64u + "}", Convert.ToString((long)data3, 2)).Replace(' ', '0'),
                ".{8}",
                "$0."
            )
            + System.Text.RegularExpressions.Regex.Replace(
        ...
        public static BitArray256 operator |(BitArray256 a, BitArray256 b) =>
            new BitArray256(a.data1 | b.data1, a.data2 | b.data2, a.data3 | b.data3, a.data4 | b.data4);
    ...
    public static class BitArrayUtilities
    {
        ...
        public static bool Get128(uint index, ulong data1, ulong data2) =>
            index < 64u ? (data1 & (1uL << (int)index)) != 0uL : (data2 & (1uL << (int)(index - 64u))) != 0uL;
