...
namespace UnityEngine.Rendering
{
    internal struct JaggedJobRange
    {
        ...
        public static NativeList<JaggedJobRange> FromSpanWithRelaxedBatchSize<T>(
            JaggedSpan<T> jaggedSpan,
            int batchSizeHint,
            Allocator allocator
        )
            where T : unmanaged
        ...
        public static NativeList<JaggedJobRange> FromSpanWithMaxBatchSize<T>(
            JaggedSpan<T> jaggedSpan,
            int maxBatchSize,
            Allocator allocator
        )
        ...
        private static NativeList<JaggedJobRange> ComputeRanges<T>(
            JaggedSpan<T> jaggedSpan,
            int batchSizeHint,
            ...
            where T : unmanaged
        {
            ...
            Assert.IsTrue(
                allocator == Allocator.TempJob || allocator == Allocator.Persistent,
            ...
            JaggedJobRangeBurst.ComputeRanges(
                JobsUtility.JobWorkerCount,
                batchSizeHint,
                jaggedSpan.totalLength,
                canExceedBatchSizeHint,
                jaggedSpan.untypedSections,
                ref jobRanges
            );
    ...
    internal static class JaggedJobRangeExtensions
    {
        public static JobHandle Schedule<T>(
            this T job,
            in NativeList<JaggedJobRange> jobRanges,
