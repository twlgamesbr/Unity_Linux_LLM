...
namespace UnityEngine.Rendering
{
    ...
    public sealed class ProbeVolumesOptions : VolumeComponent
    {
        ...
        /// </summary>
        [Tooltip(
            "Whether to animate the noise when TAA is enabled. It can potentially remove the visible noise patterns."
        )]
        ...
        public APVLeakReductionModeParameter leakReductionMode = new APVLeakReductionModeParameter(
            APVLeakReductionMode.Quality
        );
