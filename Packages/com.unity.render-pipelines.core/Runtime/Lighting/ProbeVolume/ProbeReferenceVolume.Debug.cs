...
namespace UnityEngine.Rendering
{
    ...
    internal class ProbeVolumeDebugColorPreferences
    {
        ...
        static ProbeVolumeDebugColorPreferences()
        {
            ...
            GetDetailSubdivisionColor = CoreRenderPipelinePreferences.RegisterPreferenceColor(
                "Adaptive Probe Volumes/Level 0 Subdivision",
                s_DetailSubdivision
            );
            GetMediumSubdivisionColor = CoreRenderPipelinePreferences.RegisterPreferenceColor(
                "Adaptive Probe Volumes/Level 1 Subdivision",
                s_MediumSubdivision
            );
            GetLowSubdivisionColor = CoreRenderPipelinePreferences.RegisterPreferenceColor(
                "Adaptive Probe Volumes/Level 2 Subdivision",
                s_LowSubdivision
            );
            GetVeryLowSubdivisionColor = CoreRenderPipelinePreferences.RegisterPreferenceColor(
            ...
            GetSparseSubdivisionColor = CoreRenderPipelinePreferences.RegisterPreferenceColor(
                "Adaptive Probe Volumes/Level 4 Subdivision",
                s_SparseSubdivision
            );
            GetSparsestSubdivisionColor = CoreRenderPipelinePreferences.RegisterPreferenceColor(
                "Adaptive Probe Volumes/Level 5 Subdivision",
                s_SparsestSubdivision
            );
#endif
        }
    }
    ...
    public partial class ProbeReferenceVolume
    {
        ...
        static void SceneGUI(SceneView sceneView)
        {
            ...
            if (ProbeReferenceVolume.probeSamplingDebugData.forceScreenCenterCoordinates)
                screenCoordinates = new Vector2(
                    sceneView.camera.scaledPixelWidth / 2.0f,
                    sceneView.camera.scaledPixelHeight / 2.0f
                );
            else
            ...
            if (
                ...
                || screenCoordinates.x > sceneView.camera.scaledPixelWidth
                || screenCoordinates.y < 0
                || screenCoordinates.y > sceneView.camera.scaledPixelHeight
            )
                return;
        ...
        bool TryCreateDebugRenderData()
        {
            ...
            if (
                GraphicsSettings.TryGetRenderPipelineSettings<ShaderStrippingSetting>(out var shaderStrippingSetting)
                && shaderStrippingSetting.stripRuntimeDebugShaders
            )
                return false;
#endif
            ...
            m_ProbeSamplingDebugMaterial = CoreUtils.CreateEngineMaterial(
                debugResources.probeVolumeSamplingDebugShader
            );
            ...
            probeSamplingDebugData.positionNormalBuffer = new GraphicsBuffer(
            ...
            m_DebugFragmentationMaterial = CoreUtils.CreateEngineMaterial(
                debugResources.probeVolumeFragmentationDebugShader
            );
        ...
        void RegisterDebug()
        {
            ...
            const float kProbeSizeMin = 0.05f,
                kProbeSizeMax = 10.0f;
            const float kOffsetSizeMin = 0.001f,
                kOffsetSizeMax = 0.1f;
            ...
            subdivContainer.children.Add(
                new DebugUI.FloatField
                {
                    ...
                    tooltip =
                        "How far from the Scene Camera to draw debug visualization for Cells and Bricks. Large distances can impact Editor performance.",
            ...
            subdivPreviewContainer.children.Add(
                new DebugUI.BoolField
                {
                    displayName = "Live Updates",
                    tooltip =
                        "Enable a preview of Adaptive Probe Volumes data in the Scene without baking. Can impact Editor performance.",
            ...
            realtimeSubdivisonChildContainer.children.Add(
                new DebugUI.IntField
                {
                    displayName = "Cell Updates Per Frame",
                    tooltip =
                        "The number of Cells, bricks, and probe positions updated per frame. Higher numbers can impact Editor performance.",
            ...
            realtimeSubdivisonChildContainer.children.Add(
                new DebugUI.FloatField
                {
                    ...
                    tooltip =
                        "Delay in seconds between updates to Cell, Brick, and Probe positions if Live Subdivision Preview is enabled.",
            ...
            probeContainer.children.Add(
                new DebugUI.BoolField
                {
                    displayName = "Display Probes",
                    tooltip =
                        "Render the debug view showing probe positions. Use the shading mode to determine which type of lighting data to visualize.",
            ...
            );
            {
                ...
                probeContainerChildren.children.Add(
                ...
                var exposureCompensation = new DebugUI.FloatField
                {
                    ...
                    tooltip =
                        "Modify the brightness of probe visualizations. Decrease this number to make very bright probes more visible.",
                ...
                probeContainerChildren.children.Add(
                    new DebugUI.IntField
                    {
                        ...
                        setter = (v) =>
                        {
                            ...
                            probeVolumeDebug.maxSubdivToVisualize =
                                GetMaxSubdivision() == 0
                                    ? ProbeBrickIndex.kMaxSubdivisionLevels
                                    : Mathf.Max(0, Mathf.Min(v, GetMaxSubdivision() - 1));
                        },
                        min = () => 0,
            ...
            probeContainer.children.Add(
                new DebugUI.BoolField
                {
                    ...
                    tooltip =
                        "Render the debug view displaying how probes are sampled for a selected pixel. Use the viewport overlay 'SelectPixel' button or Ctrl+Click on the viewport to select the debugged pixel",
            ...
            drawProbeSamplingDebugChildren.children.Add(
                new DebugUI.FloatField
                {
                    displayName = "Debug Size",
            ...
            drawProbeSamplingDebugChildren.children.Add(
                new DebugUI.BoolField
                {
                    ...
                    tooltip =
                        "Enable Sampling Noise for this debug view. It should be enabled for accuracy but it can make results more difficult to read",
            ...
            probeContainer.children.Add(
                new DebugUI.BoolField
                {
                    ...
                    tooltip =
                        "Enable Virtual Offset debug visualization. Indicates the offsets applied to probe positions. These are used to capture lighting when probes are considered invalid.",
                        ...
                        )
                        {
                            ...
                            var searchDistance =
                                CellSize(0)
                                    ...
                                    * m_CurrentBakingSet.settings.virtualOffsetSettings.searchMultiplier
                                + m_CurrentBakingSet.settings.virtualOffsetSettings.outOfGeoOffset;
                            probeVolumeDebug.probeSize = Mathf.Min(
                                probeVolumeDebug.probeSize,
                                Mathf.Clamp(searchDistance, kProbeSizeMin, kProbeSizeMax)
                            );
                        }
                    },
                }
            ...
            probeContainer.children.Add(
                new DebugUI.FloatField
                {
                    displayName = "Debug Draw Distance",
                    tooltip =
                        "How far from the Scene Camera to draw probe debug visualizations. Large distances can impact Editor performance.",
            ...
            var adjustmentContainer = new DebugUI.Container() { displayName = "Probe Adjustment Volumes" };
            adjustmentContainer.children.Add(
                new DebugUI.BoolField
                {
                    displayName = "Auto Display Probes",
                    tooltip =
                        "When enabled and a Probe Adjustment Volumes is selected, automatically display the probes.",
            ...
            adjustmentContainer.children.Add(
                new DebugUI.BoolField
                {
                    ...
                    tooltip =
                        "When enabled, only displayed probes in the influence of the currently selected Probe Adjustment Volumes.",
            ...
            streamingContainer.children.Add(
                new DebugUI.BoolField
                {
            ...
            maxCellStreamingContainerChildren.children.Add(
                new DebugUI.IntField
                {
                    displayName = "Loaded Cells Per Frame",
                    tooltip =
                        "Determines the maximum number of Cells Unity streams per frame. Loading more Cells per frame can impact performance.",
            ...
            if (Debug.isDebugBuild)
            {
                ...
                indexDefragContainerChildren.children.Add(
                    new DebugUI.Value
                    {
            ...
            if (supportScenarioBlending && m_CurrentBakingSet != null)
            {
                ...
                blendingContainer.children.Add(
                    new DebugUI.IntField
                    {
                ...
                void RefreshScenarioNames(string guid)
                {
                    ...
                    if (
                        ...
                        && allScenarios.Count + 1 == m_DebugScenarioNames.Length
        ...
        public void RenderFragmentationOverlay(
        ...
        )
        {
            ...
            using (
                var builder = renderGraph.AddUnsafePass<RenderFragmentationOverlayPassData>(
                    "APVFragmentationOverlay",
                    out var passData
                )
            )
            {
                ...
                builder.SetRenderFunc(
                    static (RenderFragmentationOverlayPassData data, UnsafeGraphContext ctx) =>
                    {
                        ...
                        natCmd.DrawProcedural(
                            Matrix4x4.identity,
                            data.debugFragmentationMaterial,
                            0,
        ...
        bool ShouldCullCell(Vector3 cellPosition, Transform cameraTransform, Plane[] frustumPlanes)
        {
            ...
            float distanceRoundedUpWithCellSize =
                Mathf.CeilToInt(probeVolumeDebug.probeCullingDistance / cellSize) * cellSize;
        ...
        static void UpdateDebugFromSelection(ref Vector4[] _AdjustmentVolumeBounds, ref int _AdjustmentVolumeCount)
        {
            ...
            foreach (var touchup in Selection.GetFiltered<ProbeAdjustmentVolume>(SelectionMode.Unfiltered))
            {
                ...
                Volume volume = new Volume(
                    Matrix4x4.TRS(touchup.transform.position, touchup.transform.rotation, touchup.GetExtents()),
                    0,
                    0
                );
                ...
                _AdjustmentVolumeBounds[_AdjustmentVolumeCount * 3 + 0] = new Vector4(
                    center.x,
                    center.y,
                    center.z,
                    volume.Z.x
                );
                _AdjustmentVolumeBounds[_AdjustmentVolumeCount * 3 + 1] = new Vector4(
                    volume.X.x,
                    volume.X.y,
                    volume.X.z,
                    volume.Z.y
                );
                _AdjustmentVolumeBounds[_AdjustmentVolumeCount * 3 + 2] = new Vector4(
                    volume.Y.x,
                    volume.Y.y,
                    volume.Y.z,
                    volume.Z.z
        ...
        void DrawProbeDebug(Camera camera, Texture exposureTexture)
        {
            ...
            bool debugDraw =
                drawProbes || probeVolumeDebug.drawVirtualOffsetPush || probeVolumeDebug.drawProbeSamplingDebug;
            ...
            if (probeVolumeDebug.drawProbeSamplingDebug)
            {
                ...
                m_ProbeSamplingDebugMaterial.SetInt(
                    "_RenderingLayerMask",
                    (int)probeVolumeDebug.samplingRenderingLayer
                );
                ...
                m_ProbeSamplingDebugMaterial.SetInt(
                    "_DebugSamplingNoise",
                    Convert.ToInt32(probeVolumeDebug.debugWithSamplingNoise)
                );
                ...
                m_ProbeSamplingDebugMaterial.SetBuffer(
                    "_positionNormalBuffer",
                    probeSamplingDebugData.positionNormalBuffer
                );

                Graphics.DrawMesh(
                    m_DebugProbeSamplingMesh,
            ...
            int maxSubdivToVisualize = Mathf.Max(
                0,
                Mathf.Min(probeVolumeDebug.maxSubdivToVisualize, GetMaxSubdivision() - 1)
            );
            int minSubdivToVisualize = Mathf.Clamp(
                probeVolumeDebug.minSubdivToVisualize,
                minAvailableSubdiv,
                maxSubdivToVisualize
            );
            ...
            foreach (var cell in cells.Values)
            {
                ...
                if (
                    adjustmentCulling
                    && ShouldCullCell(cell.desc.position, adjustmentVolumeBounds, adjustmentVolumeCount)
                )
                    continue;
                ...
                for (int i = 0; i < debug.probeBuffers.Count; ++i)
                {
                    ...
                    props.SetFloat(
                        "_ValidityThreshold",
                        m_CurrentBakingSet.settings.dilationSettings.dilationValidityThreshold
                    );
                    ...
                    if (drawProbes)
                    {
                        ...
                        m_DebugMaterial.SetInt(
                            "_AdjustmentVolumeCount",
                            probeVolumeDebug.isolationProbeDebug ? adjustmentVolumeCount : 0
                        );
                        m_DebugMaterial.SetVector(
                            "_ScreenSize",
                            new Vector4(
                                camera.pixelWidth,
                                camera.pixelHeight,
                    ...
                    if (probeVolumeDebug.drawProbeSamplingDebug)
                    {
                        ...
                        m_ProbeSamplingDebugMaterial02.SetBuffer(
                            "_positionNormalBuffer",
                            probeSamplingDebugData.positionNormalBuffer
                        );
                        Graphics.DrawMeshInstanced(
        ...
        internal static Vector3 DecodeSkyShadingDirection(uint directionIndex)
        {
            ...
            return directionIndex == precomputedDirections.Length
                ? new Vector3(0.0f, 0.0f, 0.0f)
                : precomputedDirections[directionIndex];
        }
        ...
        )
        {
            ...
            foreach (var cell in cells.Values)
            {
                ...
                if (
                    !cell.data.bricks.IsCreated
                    || cell.data.bricks.Length == 0
                    || !cell.data.probePositions.IsCreated
                    || !cell.loaded
                )
                    return false;
                ...
                for (int brickIndex = 0; brickIndex < brickCount; ++brickIndex)
                {
                    ...
                    for (int z = 0; z < ProbeBrickPool.kBrickProbeCountPerDim; ++z)
                    {
                        for (int y = 0; y < ProbeBrickPool.kBrickProbeCountPerDim; ++y)
                        {
                            ...
                            {
                                Vector3Int texelLoc = new Vector3Int(
                                    brickStart.x + x,
                                    brickStart.y + y,
                                    brickStart.z + z
                                );
                                ...
                                int probeFlatIndex =
                                    chunkIndex * chunkSizeInProbes + (bx + x) + loc.x * ((by + y) + loc.y * (bz + z));
                                ...
                                if (scenarioData.probeOcclusion.Length != 0)
                                {
                                    ...
                                    occlusionList.Add(
                                        new Vector4(occlusionValue0, occlusionValue1, occlusionValue2, occlusionValue3)
                                    );
                                }
                                ...
                                if (cell.data.skyOcclusionDataL0L1.Length > 0)
                                {
                                    ...
                                    var skyOccSH_dc = Mathf.HalfToFloat(
                                        cell.data.skyOcclusionDataL0L1[probeFlatIndex * 4]
                                    );
                                    var skyOccSH_x = Mathf.HalfToFloat(
                                        cell.data.skyOcclusionDataL0L1[probeFlatIndex * 4 + 1]
                                    );
                                    var skyOccSH_y = Mathf.HalfToFloat(
                                        cell.data.skyOcclusionDataL0L1[probeFlatIndex * 4 + 2]
                                    );
                                    var skyOccSH_z = Mathf.HalfToFloat(
                                        cell.data.skyOcclusionDataL0L1[probeFlatIndex * 4 + 3]
                                    );
                                ...
                                {
                                    L0_L1Rx[channel] = Mathf.HalfToFloat(
                                        scenarioData.shL0L1RxData[probeFlatIndex * 4 + channel]
                                    );
                                    L1G_L1Ry[channel] =
                                        scenarioData.shL1GL1RyData[probeFlatIndex * 4 + channel] / 255.0f;
                                    L1B_L1Rz[channel] =
                                        scenarioData.shL1BL1RzData[probeFlatIndex * 4 + channel] / 255.0f;

                                    if (
                                        ProbeReferenceVolume.instance.shBands == ProbeVolumeSHBands.SphericalHarmonicsL2
                                    )
                                    {
        ...
        CellInstancedDebugProbes CreateInstancedProbes(Cell cell)
        {
            ...
            float[] touchupUpVolumeAction =
                cell.data.touchupVolumeInteraction.Length > 0 ? new float[kProbesPerBatch] : null;
                ...
                for (int z = 0; z < ProbeBrickPool.kBrickProbeCountPerDim; ++z)
                {
                    for (int y = 0; y < ProbeBrickPool.kBrickProbeCountPerDim; ++y)
                    {
                        for (int x = 0; x < ProbeBrickPool.kBrickProbeCountPerDim; ++x)
                        {
                            ...
                            probeBuffer.Add(
                                Matrix4x4.TRS(position, Quaternion.identity, Vector3.one * (0.3f * (brickSize + 1)))
                            );
                            ...
                            layer[idxInBatch] = Unity.Mathematics.math.asfloat(
                                cell.data.layer.Length > 0 ? cell.data.layer[probeFlatIndex] : 0xFFFFFFFF
                            );

                            if (touchupUpVolumeAction != null)
                            {
                                touchupUpVolumeAction[idxInBatch] = cell.data.touchupVolumeInteraction[probeFlatIndex];
                                dilationThreshold[idxInBatch] =
                                    touchupUpVolumeAction[idxInBatch] > 1.0f
                                        ? touchupUpVolumeAction[idxInBatch] - 1.0f
                                        : baseThreshold;
                            }
