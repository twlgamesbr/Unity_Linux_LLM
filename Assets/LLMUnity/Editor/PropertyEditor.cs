...
namespace LLMUnity
{
    public class PropertyEditor : Editor
    {
        ...
        {
            bool remote = llmScriptSO.FindProperty("_remote").boolValue;
            List<Type> attributeClasses = new List<Type>(){typeof(LocalRemoteAttribute), typeof(LLMAttribute)};
            if (remote) attributeClasses.Add(typeof(RemoteAttribute));
            else attributeClasses.Add(typeof(LocalAttribute));
