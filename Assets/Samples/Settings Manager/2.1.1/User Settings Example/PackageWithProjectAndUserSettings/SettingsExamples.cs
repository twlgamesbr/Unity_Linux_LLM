...
#pragma warning disable 414
        ...
        static MySetting<int> s_NumberOfDaysWithoutIncident = new MySetting<int>(
            "general.daysWithoutIncident",
            0,
            SettingsScope.User
        );

        [UserSetting("General Settings", "Favorite Color")]
        static MySetting<Color> s_FavoriteColor = new MySetting<Color>(
            "general.favoriteColor",
            Color.magenta
        );

        [UserSetting("General Settings", "Vector2 Field")]
        static MySetting<Vector2> s_Vector2Value = new MySetting<Vector2>(
            "general.vector2Value",
            new Vector2(2f, 4f)
        );

        [UserSetting("General Settings", "Editor Flags")]
        static MySetting<StaticEditorFlags> s_EditorFlags = new MySetting<StaticEditorFlags>(
            "general.editorFlags",
...
#pragma warning restore 414
        ...
        [UserSetting]
        static MySetting<FooClass> s_Foo = new MySetting<FooClass>(
            "general.foo",
            new FooClass(),
        ...
        [UserSetting]
        static MySetting<int> s_NumberWithSlider = new MySetting<int>(
            "general.conditionalValue",
            5,
            SettingsScope.Project
        );
        ...
        static void ConditionalValueGUI(string searchContext)
        {
            ...
            s_NumberWithSlider.value = SettingsGUILayout.SettingsSlider(
                "Number With Slider",
                s_NumberWithSlider,
                0,
                10,
            ...
            using (new SettingsGUILayout.IndentedGroup("Foo Class"))
            {
                ...
                foo.intValue = SettingsGUILayout.SearchableIntField(
                    "Int Value",
                    foo.intValue,
                    searchContext
                );
                foo.stringValue = SettingsGUILayout.SearchableTextField(
                    "String Value",
                    foo.stringValue,
                    searchContext
                );
